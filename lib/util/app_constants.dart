...
import 'package:liwas_user/common/models/choose_us_model.dart';
...
class AppConstants {
  ...
  /// Shared Key
  static const String theme = 'liwas_user_theme';
  static const String token = 'liwas_user_token';
  static const String countryCode = 'liwas_user_country_code';
  static const String languageCode = 'liwas_user_language_code';
  static const String cacheCountryCode = 'cache_country_code';
  static const String cacheLanguageCode = 'cache_language_code';
  static const String cartList = 'liwas_user_cart_list';
  static const String userPassword = 'liwas_user_user_password';
  static const String userAddress = 'liwas_user_user_address';
  static const String userNumber = 'liwas_user_user_number';
  static const String userCountryCode = 'liwas_user_user_country_code';
  static const String notification = 'liwas_user_notification';
  static const String notificationIdList = 'notification_id_list';
  static const String searchHistory = 'liwas_user_search_history';
  static const String intro = 'liwas_user_intro';
  static const String notificationCount = 'liwas_user_notification_count';
  static const String dmTipIndex = 'liwas_user_dm_tip_index';
  static const String earnPoint = 'liwas_user_earn_point';
  static const String acceptCookies = 'liwas_user_accept_cookies';
  static const String suggestedLocation = 'liwas_user_suggested_location';
  static const String walletAccessToken = 'liwas_user_wallet_access_token';
  static const String guestId = 'liwas_user_guest_id';
  static const String guestNumber = 'liwas_user_guest_number';
  static const String referBottomSheet = 'liwas_user_reffer_bottomsheet_show';
  static const String dmRegisterSuccess = 'liwas_user_dm_registration_success';
  static const String isRestaurantRegister = 'liwas_user_store_registration';
  static const String suggestLogin = 'liwas_user_login_suggestion';

  ///taxi
  static const String taxiSearchHistory = 'liwas_user_taxi_search_history';
  static const String taxiSearchAddressHistory =
      'liwas_user_taxi_search_address_history';
  ...
  static final dataList = [
    'Invite your friends and business'.tr,
    '${'They register'.tr} ${AppConstants.appName} ${'With special offer'.tr}',
    'You made your earning'.tr,
  ];
  ...
  static List<ChooseUsModel> whyChooseUsList = [
    ChooseUsModel(
        ...
        title: 'Trusted by customers and store owners'),
    ChooseUsModel(icon: Images.landingStores, title: 'Thousands of stores'),
    ChooseUsModel(
        icon: Images.landingExcellent, title: 'Excellent shopping experience'),
    ChooseUsModel(
        icon: Images.landingCheckout,
        title: 'Easy checkout and payment system'),
  ];
