...
import 'package:liwas_user/helper/notification_helper.dart';
import 'package:liwas_user/helper/responsive_helper.dart';
import 'package:liwas_user/helper/route_helper.dart';
import 'package:liwas_user/theme/dark_theme.dart';
import 'package:liwas_user/theme/light_theme.dart';
import 'package:liwas_user/util/app_constants.dart';
import 'package:liwas_user/util/messages.dart';
import 'package:liwas_user/helper/tracking_helper.dart';
...
Future<void> main() async {
  ...
  if (GetPlatform.isWeb) {
    ...
    await Firebase.initializeApp(
      options: const FirebaseOptions(
        apiKey: "AIzaSyDgpK2c0Lt6_5Ddwq3Wss-4IIAkXBdZ3Sw",
        appId: "1:578255787212:android:d418e731ecb76b36bf9e69",
        messagingSenderId: "578255787212",
        projectId: "liwas-793a1",
      ),
    );
