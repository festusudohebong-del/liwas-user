      ...
      return PopScope(
        ...
        child: Scaffold(
          appBar: (ResponsiveHelper.isDesktop(context) ? const WebMenuBar() : AppBar(
            ...
            ) : Text(widget.categoryName, style: ralewayRegular.copyWith(
                      ...
                      child: TabBarView(
                        ...
                        children: [
                          SingleChildScrollView(
                            ...
                            child: ItemsView(
                              isStore: false, items: item, stores: null, noDataText: 'No category item found'.tr,
                            ),
                          ),
                          SingleChildScrollView(
                            ...
                            child: ItemsView(
                              ...
                              noDataText: Get.find<SplashController>().configModel!.moduleConfig!.module!.showRestaurantText! ? 'No category restaurant found'.tr : 'No category store found'.tr,
                            ),
                          ),
                        ],
                      ),
