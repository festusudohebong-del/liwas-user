            ...
            child: Column(children: [
              ...
              SizedBox(
                ...
                child: brandsController.brandItems != null ? brandsController.brandItems!.isNotEmpty
                    ? ItemsView(isStore: false, items: brandsController.brandItems, stores: null, noDataText: 'No brand item found'.tr)
                    : Center(child: Padding(padding: EdgeInsets.only(top: isDesktop ? context.height * 0.3 : context.height * 0.4), child: Text('No brand item found'.tr)))
