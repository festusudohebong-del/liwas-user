        ...
        return SingleChildScrollView(
          child: FooterView(
            child: Column(children: [
              ...
              WebScreenTitleWidget(title: 'All brands'.tr),
              ...
              SizedBox(
                ...
                ) : Center(child: Padding(padding: EdgeInsets.only(top: isDesktop ? context.height * 0.3 : context.height * 0.4), child: Text('No brands found'.tr)))
