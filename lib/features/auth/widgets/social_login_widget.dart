      ...
      return Column(
        ...
        children: [
          canGoogleAndFacebookLogin ? Column(children: [
            ...
            showWelcomeText ? Text('${'Welcome to'.tr} ${AppConstants.appName}', style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge)) : const SizedBox(),
              ...
              child: CustomInkWell(
                ...
                child: Padding(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    Text('Continue with google'.tr, style: ralewayMedium.copyWith()),
                  ]),
                ),
              ),
            ) : const SizedBox(),
              ...
              child: CustomInkWell(
                ...
                child: Padding(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    Text('Continue with facebook'.tr, style: ralewayMedium.copyWith()),
                  ]),
                ),
              ),
            ) : const SizedBox(),
              ...
              child: CustomInkWell(
                ...
                child: Padding(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    ...
                    Text('Continue with apple'.tr, style: ralewayMedium.copyWith()),
                  ]),
                ),
              ),
            ) : const SizedBox(),
      ...
      Padding(
        ...
        child: Row(children: [
          ...
          Padding(
            ...
            child: Text('Or continue with'.tr, style: ralewayMedium.copyWith(color: Theme.of(context).disabledColor)),
          ),
          Expanded(child: Container(height: 1, color: Theme.of(context).disabledColor)),
        ]),
      ),
