    ...
    return storeRegController.zoneList != null ? storeRegController.zoneList!.isNotEmpty ? Stack(clipBehavior: Clip.none, children: [
      ...
      Container(
        ...
        child: CustomDropdown<int>(
          ...
          child: Padding(
            ...
            child: Text(storeRegController.selectedZoneIndex == -1 ? 'Select zone'.tr : storeRegController.zoneList![storeRegController.selectedZoneIndex!].name.toString()),
          ),
        ),
      ),
      ...
      Positioned(
        ...
        child: Container(
          ...
          child: Text('Select zone'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: isDesktop ? Dimensions.fontSizeExtraSmall : Dimensions.fontSizeDefault)),
        ),
      ),
      ...
      child: Center(child: Text('Service not available in this area'.tr)),
    ) : Shimmer(
      child: Container(
        height: 45, width: context.width,
        decoration: BoxDecoration(
