        ...
        Container(
          ...
          child: Column(crossAxisAlignment : isDesktop ? CrossAxisAlignment.start : CrossAxisAlignment.center, children: [
            ...
            Align(
              ...
              child: Text(title, style: ralewayMedium.copyWith(color: storeRegistrationController.businessIndex == index ? Theme.of(context).primaryColor : Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.7), fontSize: Dimensions.fontSizeDefault,
            ...
            isDesktop ? Text(
              description ?? '', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall,
