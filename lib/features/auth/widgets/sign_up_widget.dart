...
import 'package:liwas_user/features/auth/domain/models/signup_body_model.dart';
            ...
            Padding(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  isDesktop ? Align(
                    ...
                    child: Text('Sign up'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge)),
                  ) : const SizedBox(),
                  ...
                  Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Expanded(
                      child: CustomTextField(
                        ...
                        validator: (value) => ValidateCheck.validateEmptyText(value, "Please enter your name".tr),
                      ),
                    ),
                    ...
                    (Get.find<SplashController>().configModel!.refEarningStatus == 1 && isDesktop) ? Expanded(
                      child: CustomTextField(
                        titleText: 'Refer code'.tr,
                        labelText: 'Refer code'.tr,
                        showLabelText: true,
                ...
                SizedBox(height: isDesktop ? Dimensions.paddingSizeExtraLarge : Dimensions.paddingSizeLarge),
                  ...
                  Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    isDesktop ? Expanded(child: CustomTextField(
                      titleText: 'Re enter your password'.tr,
                ...
                SizedBox(height: isDesktop ? Dimensions.paddingSizeExtraLarge : Dimensions.paddingSizeLarge),
                  ...
                  Padding(
                    ...
                    child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                      Text('Already have account'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).hintColor)),
