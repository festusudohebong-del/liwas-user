    ...
    return GetBuilder<AuthController>(builder: (authController) {
      ...
      return Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        CustomTextField(
          ...
          titleText: 'Enter email or phone'.tr,
          ...
          validator: (String? value){
            ...
            return (GetUtils.isPhoneNumber(authController.countryDialCode+value!.tr) || GetUtils.isEmail(value.tr)) ? null : 'Enter email address or phone number'.tr;
          },
        ),
        ...
        CustomTextField(
          ...
          required: true,
          validator: (value) => ValidateCheck.validateEmptyText(value, "Please enter password".tr),
        ),
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          ...
          TextButton(
            ...
            child: Text('${'Forgot password'.tr}?', style: ralewayRegular.copyWith(color: Theme.of(context).primaryColor)),
          ),
        ]),
        ...
        onOtpViewClick != null ? Column(children: [
          Text('Or'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).disabledColor)),
          const SizedBox(height: Dimensions.paddingSizeExtraSmall),

          Row(mainAxisSize: MainAxisSize.min, children: [
            Text('Sign in with'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).disabledColor)),
            const SizedBox(width: Dimensions.paddingSizeExtraSmall),

            InkWell(
              onTap: onOtpViewClick,
              child: Text('Otp'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).primaryColor, decoration: TextDecoration.underline)),
            ),
          ]),
        ]) : const SizedBox(),
        ...
        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          Text('Do not have account'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).hintColor)),
          ...
          InkWell(
            ...
            child: Padding(
              ...
              child: Text('Sign up'.tr, style: ralewayMedium.copyWith(color: Theme.of(context).primaryColor)),
            ),
          ),
        ]),
        ...
        Expanded(
          ...
          child: Column(children: [
            Align(
              ...
              child: Text('Login'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge)),
            ),
            ...
            CustomTextField(
              ...
              validator: (String? value){
                ...
                return (GetUtils.isPhoneNumber(value!.tr) || GetUtils.isEmail(value.tr)) ? null : 'Enter email address or phone number'.tr;
              },
            ),
            const SizedBox(height: Dimensions.paddingSizeExtraLarge),
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              InkWell(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    Text('Remember me'.tr, style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                  ],
                ),
              ),
              ...
              TextButton(
                ...
                child: Text('${'Forgot password'.tr}?', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor)),
              ),
            ]),
            ...
            child: CustomInkWell(
              ...
              child: Padding(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text('Otp sign in'.tr, style: ralewayMedium.copyWith()),
                ]),
              ),
            ),
          ) : const SizedBox(),
