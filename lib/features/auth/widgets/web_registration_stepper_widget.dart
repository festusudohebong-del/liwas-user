...
class RegistrationStepperWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(children: [
      RegistrationStepper(
        title: 'General information'.tr, isActive: true, haveLeftBar: false, haveRightBar: true, rightActive: true, onGoing: state == 0, state: 1,
      ),
      RegistrationStepper(
        title: 'Business plan'.tr, isActive: state > 1, haveLeftBar: true, haveRightBar: true, rightActive: state > 1, onGoing: state == 1, processing: state != 3 && state != 0, state: 2,
      ),
      RegistrationStepper(
        ...
        Row(children: [
          ...
          Stack(
            ...
            children: [
              ...
              (onGoing || processing || rightActive) ? const SizedBox() : Positioned(
                ...
                child: Center(child: Text( state == 1 ? '' : state == 2 ? '2' : '3', style: ralewayMedium.copyWith(color: Colors.white, fontSize: Dimensions.fontSizeSmall),)),
              ),
            ],
          ),
          ...
          Padding(
            ...
            child: Text(
              ...
              style: ralewayRegular.copyWith(color: (onGoing || processing || rightActive) ? Theme.of(context).textTheme.bodyLarge?.color : Theme.of(context).disabledColor),
            ),
          ),
