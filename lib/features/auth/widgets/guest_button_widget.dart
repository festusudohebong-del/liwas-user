      ...
      builder: (authController) {
        return !authController.guestLoading ? TextButton(
          ...
          child: RichText(text: TextSpan(children: [
            TextSpan(text: '${'Continue as'.tr} ', style: ralewayRegular.copyWith(color: Theme.of(context).disabledColor)),
            TextSpan(text: 'Guest'.tr, style: ralewayMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color)),
          ])),
