      ...
      return storeRegController.moduleList != null ? Stack(clipBehavior: Clip.none, children: [
        ...
        Container(
          ...
          child: CustomDropdown<int>(
            ...
            child: Padding(
              ...
              child: Text(storeRegController.selectedModuleIndex == -1 ? 'Select module type'.tr : storeRegController.moduleList![storeRegController.selectedModuleIndex!].moduleName.toString()),
            ),
          ),
        ),
        ...
        Positioned(
          ...
          child: Container(
            ...
            child: Text('Select module'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: isDesktop ? Dimensions.fontSizeExtraSmall : Dimensions.fontSizeDefault)),
          ),
        ),

      ]) : Center(child: Text('Not available module'.tr));
