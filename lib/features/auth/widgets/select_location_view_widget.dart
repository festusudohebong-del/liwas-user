...
import 'package:liwas_user/features/auth/widgets/pickup_zone_widget.dart';
import 'package:liwas_user/features/auth/widgets/zone_selection_widget.dart';
...
import 'package:liwas_user/features/location/widgets/location_search_dialog_widget.dart';
          ...
          child: SingleChildScrollView(
            child: isDesktop && widget.fromView ? webView(storeRegController, zoneList): Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              !storeRegController.inZone ? Padding(
                ...
                child: Row(children: [
                  Text('* ', style: ralewayBold.copyWith(color: Colors.red)),
                  Text('Please place the marker inside the zone'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).colorScheme.error)),
                ]),
              ) : const SizedBox(),
              ...
              widget.fromView && !isDesktop ? CustomTextField(
                titleText: 'Write store address'.tr,
                ...
                showTitle: isDesktop,
                required: true,
                validator: (value) => ValidateCheck.validateEmptyText(value, "Store address field is required".tr),
              ) : const SizedBox(),
        ...
        child: ClipRRect(
          ...
          child: Stack(clipBehavior: Clip.none, children: [
             ...
             Positioned(
               ...
               child: InkWell(
                 ...
                 child: Container(
                   ...
                   child: Text('Search'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).hintColor)),
                 ),
               ),
            ),
                ...
                onTap: () {
                  if(storeRegController.selectedZoneIndex == -1) {
                    ...
                    if(ResponsiveHelper.isDesktop(context)) {
                      ...
                      Get.to(Scaffold(
                        appBar: CustomAppBar(title: 'Set your store location'.tr),
            ...
            !widget.fromView ? Positioned(
              ...
              child: CustomButton(
                buttonText: storeRegController.inZone ? 'Set location'.tr : 'Not in zone'.tr,
                onPressed: storeRegController.inZone ? () {
                  try{
                    widget.mapController!.moveCamera(CameraUpdate.newCameraPosition(_cameraPosition));
                    Get.back();
                  } catch(e){
                    showCustomSnackBar('Please setup the marker in your required location'.tr);
                  }
                } : null,
              ),
            ) : const SizedBox(),
