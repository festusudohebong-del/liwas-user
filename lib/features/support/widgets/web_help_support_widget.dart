        ...
        children: [
          ...
          SingleChildScrollView(
            child: Align(
              ...
              child: Column(
                children: [
                  WebScreenTitleWidget(title: 'Help support'.tr),
                  Padding(
                    padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeLarge),
                    child: Column(children: [
                      const SizedBox(height: 50),

                      Text('How we can help you'.tr, style: ralewayBold.copyWith( fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).cardColor,
                      )),
                      const SizedBox(height: Dimensions.paddingSizeSmall),

                      Text('Hey let us know your problem'.tr, style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).cardColor)),
                      const SizedBox(height: 50),
                          ...
                          child: Column(
                            children: [
                              Row(children: [
                                  ...
                                  child: element(context,
                                      ...
                                      onTap: () async {
                                        if (await canLaunchUrlString('tel:${Get.find<SplashController>().configModel!.phone}')) {
                                          ...
                                          showCustomSnackBar('${'Can not launch'.tr} ${Get.find<SplashController>().configModel!.phone}');
                                        }
                                      }
                                  ),
                                )),
                                ...
                                Expanded(child: customCard(context,
                                  child: element(context,
                                    image: Images.helpEmail, title: 'Email us'.tr,
