...
import 'package:liwas_user/features/support/widgets/web_help_support_widget.dart';
...
import 'package:liwas_user/features/support/widgets/support_button_widget.dart';
...
class _SupportScreenState extends State<SupportScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: 'Help support'.tr),
      ...
      body: SingleChildScrollView(
        ...
        child: Center(child: FooterView(
          child: ResponsiveHelper.isDesktop(context) ? const SizedBox(
            ...
            SupportButtonWidget(
              icon: Icons.mail_outline, title: 'Email us'.tr, color: Colors.green,
