...
import 'package:liwas_user/common/widgets/web_search_field.dart';
import 'package:liwas_user/features/chat/widgets/chatting_shimmer.dart';
import 'package:liwas_user/features/chat/widgets/message_bubble_widget.dart';
import 'package:liwas_user/features/chat/widgets/web_conversation_list_view_widget.dart';
                                          ...
                                          child: Column(
                                            ...
                                            Row(
                                              children: [
                                                ...
                                                // Text('(${widget.chatController.notificationBody!.receiverType!.tr})', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor)),
                                              ],
                                            ),
                                            const SizedBox(
                                                height: Dimensions
                                ...
                                child: widget.chatController.notificationBody !=
                                    ...
                                    ? widget.chatController.messageModel != null
                                        ? widget.chatController.messageModel!
                                            ...
                                            : Center(
                                                child:
                                                    Text('No message found'.tr))
                                        : const ChattingShimmer()
                                    : Center(
                                        child: Text(
                                            'No conversation selected'.tr))),
