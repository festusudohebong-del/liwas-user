...
import 'package:liwas_user/features/chat/widgets/image_file_view_widget.dart';
...
import 'package:liwas_user/features/chat/domain/models/chat_model.dart';
            ...
            child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              if(message.message != null) Flexible(
                child: Container(
                  ...
                  child: Text(message.message ?? '', style: ralewayRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color, fontSize: Dimensions.fontSizeSmall)),
                ),
              ),
      ...
      child: Column(children: [
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Expanded(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Row(children: [
                  Text('${'Order id'.tr} ', style: ralewayMedium),
                  Text('#${order.id}', style: ralewayBold),
                ]),

                Text('${'Total'.tr}: ${PriceConverter.convertPrice(order.orderAmount ?? 0)}', style: ralewayMedium.copyWith(color: Theme.of(context).primaryColor)),
              ...
              child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.end, children: [
                Container(
                  ...
                  child: Text(
                    ...
                    style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Colors.deepPurple),
                  ),
                ),

                Text(DateConverter.stringToLocalDateOnly(order.createdAt!), style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall)),
              ]),
            ),
        ...
        Container(
          ...
          child: Row(children: [
            ...
            Expanded(
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text('Delivery address'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall)),
                const SizedBox(height: Dimensions.paddingSizeExtraSmall),

                Text(order.deliveryAddress?.contactPersonNumber??'', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),

                RichText(
                  textAlign: TextAlign.start, maxLines: 2, overflow: TextOverflow.ellipsis,
                  text: TextSpan(
                    style: ralewayRegular.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color, fontSize: Dimensions.fontSizeSmall,),
                    children: [
            ...
            order.detailsCount != null && order.detailsCount! > 0 ? Container(
              ...
              padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
              child: Column(children: [
                Text('Items'.tr, style: ralewayRegular),
                Text(order.detailsCount.toString(), style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeOverLarge)),
              ]),
            ) : const SizedBox(),
