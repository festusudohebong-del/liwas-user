...
import 'package:liwas_user/features/chat/widgets/chat_serach_field_widget.dart';
...
import 'package:liwas_user/features/chat/widgets/web_chat_view_widget.dart';
...
class _ConversationScreenState extends State<ConversationScreen> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ChatController>(builder: (chatController) {
      ...
      return Scaffold(
        appBar: CustomAppBar(title: 'Conversation list'.tr, backButton: !widget.fromNavBar),
        ...
        floatingActionButton: (chatController.conversationModel != null && !chatController.hasAdmin) && !ResponsiveHelper.isDesktop(context) ? FloatingActionButton.extended(
          label: SizedBox(
            ...
            child: Text(
              '${'Chat with'.tr} ${Get.find<SplashController>().configModel!.businessName}',
                maxLines: 2, overflow: TextOverflow.ellipsis,
                style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Colors.white),
            ),
          ),
        ...
        body: ResponsiveHelper.isDesktop(context) ? WebChatViewWidget(
          ...
          child: Column(children: [
                          ...
                          child: CustomInkWell(
                            onTap: () {
                              if(user != null) {
                                ...
                                showCustomSnackBar('${type!.tr} ${'Not found'.tr}');
                              }
                            },
                            ...
                            child: Stack(children: [
                              Padding(
                                ...
                                child: Row(children: [
                                  ...
                                  Expanded(child: Column(mainAxisAlignment: MainAxisAlignment.start, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    ...
                                    user != null ? Text(
                                      '${user.fName} ${user.lName}', style: ralewayMedium,
                                    ) : Text('${type!.tr} ${'Deleted'.tr}', style: ralewayMedium),
                              ...
                              Positioned(
                                ...
                                child: Text(
                                  ...
                                  style: ralewayRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeExtraSmall),
                                ),
                              ),
            ...
            ) : Center(child: Text('No conversation found'.tr)) : const Center(child: CircularProgressIndicator()) :  NotLoggedInScreen(callBack: (value){
              initCall();
              setState(() {});
            })),
