...
import 'package:liwas_user/features/chat/enums/user_type_enum.dart';
...
import 'package:liwas_user/features/chat/widgets/message_bubble_widget.dart';
      ...
      return PopScope(
        ...
        child: Scaffold(
          ...
          appBar: (ResponsiveHelper.isDesktop(context) ? const WebMenuBar() : AppBar(
            ...
            title: Text(
              chatController.messageModel != null ? '${chatController.messageModel!.conversation!.receiver!.fName}'' ${chatController.messageModel!.conversation!.receiver!.lName}' : 'Receiver name'.tr,
          ...
          body: isLoggedIn ? ResponsiveHelper.isDesktop(context) ? Column(children: [
            ...
            Container(
              ...
              child: Center(child: Text('Live chat'.tr, style: ralewayMedium)),
            ),
                              ...
                              child: Column(children: [
                                ...
                                GetBuilder<ChatController>(builder: (chatController) {
                                  return SizedBox(
                                    ...
                                    ) : Center(child: Text('No message found'.tr)) : const Center(child: CircularProgressIndicator()),
                                  );
                                }),
                                      ...
                                      Expanded(
                                        child: TextField(
                                          ...
                                          decoration: InputDecoration(
                                            ...
                                            hintStyle: ralewayRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeLarge),
                                          ),
                                          ...
                                          onTap: () async {
                                            if(showMessageSuggestion) {
                                              ...
                                              if(chatController.isSendButtonActive) {
                                                ...
                                                showCustomSnackBar('Write something'.tr);
                                              }
                                            }
                                          },
                                          child: Padding(
                    ...
                    children: [
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        ...
                        Padding(
                          ...
                          child: Text('Choose the reason for support'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
                        ),
                                ...
                                child: TextHover(
                                  builder: (isHovered) {
                                    return Container(
                                      ...
                                      child: Text(orderController.supportReasons![index]??'', style: isHovered ? ralewayMedium : ralewayRegular),
                                    );
                                  }
                                ),
                              );
