    ...
    return Column(
      children: [
        Container(
          ...
          child: Text(timeCount > 9 ? timeCount.toString() : '0${timeCount.toString()}' , style: ralewayBold.copyWith(color: Colors.white)),
        ),
        const SizedBox(height: Dimensions.paddingSizeSmall),
        Text(timeUnit, style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor, fontWeight: FontWeight.w500)),
      ],
    );
  }
}
