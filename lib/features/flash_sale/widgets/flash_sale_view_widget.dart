...
import 'package:liwas_user/features/home/widgets/components/flash_sale_card_widget.dart';
...
import 'package:liwas_user/features/flash_sale/widgets/timer_widget.dart';
import 'package:liwas_user/features/flash_sale/widgets/flash_sale_timer_view_widget.dart';
    ...
    return GetBuilder<FlashSaleController>(builder: (flashSaleController) {
      ...
      return flashSaleController.flashSaleModel != null ? flashSaleController.flashSaleModel!.activeProducts != null && flashSaleController.duration!.inSeconds > 1 ?  Container(
        ...
        child: Column(children: [
            ...
            child: CustomInkWell(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.start, children: [
                Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('Flash sale'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                  const SizedBox(height: Dimensions.paddingSizeExtraSmall),

                  Text('Limited time offer'.tr, style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                ]),

                Text('See all'.tr, style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor, decoration: TextDecoration.underline, decorationColor: Theme.of(context).disabledColor, decorationThickness: 1.5)),
          ...
          SizedBox(
            width: Get.width * 0.7,
            child: Text("${item!.name}", style: ralewayRegular, maxLines: 1, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center),
          ),
          const SizedBox(height: Dimensions.paddingSizeExtraSmall),
          ...
          Padding(
            ...
            child: Row(children: [
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                ResponsiveHelper.isDesktop(context) ? const SizedBox() : Text('Limited time offer'.tr, style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
              ],
              ),
              const Spacer(),
