              ...
              ResponsiveHelper.isDesktop(context) ? Positioned(
                ...
                child: remaining == 0 ? Center(
                  child: Container(
                    ...
                    child: Text('Sold out'.tr, style: ralewayMedium.copyWith(color: Colors.red)),
                  ),
                ) : CartCountView(
                  item: product.item!,
                  index: index,
          ...
          Expanded(
            ...
            child: Padding(
              ...
              child: Column(
                ...
                children: [
                  Text(product.item!.name ?? '', maxLines: 2, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center, style: ralewayMedium),
