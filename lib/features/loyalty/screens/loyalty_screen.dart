...
import 'package:liwas_user/features/loyalty/widgets/loyalty_card_widget.dart';
import 'package:liwas_user/features/loyalty/widgets/loyalty_history_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        appBar: CustomAppBar(title: 'Loyalty points'.tr, backButton: true, onBackPressed: () {
          if(widget.fromNotification) {
            Get.offAllNamed(RouteHelper.getInitialRoute());
          }else {
            Get.back();
        ...
        floatingActionButton: isLoggedIn && !ResponsiveHelper.isDesktop(context) ? FloatingActionButton.extended(
          ...
          label: Text( 'Convert to wallet money'.tr, style: ralewayBold.copyWith(color: Colors.white, fontSize: Dimensions.fontSizeDefault)),
          onPressed: (){
            Get.dialog(
              ...
              return isLoggedIn ? profileController.userInfoModel != null ? SafeArea(
                child: RefreshIndicator(
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                        WebScreenTitleWidget(title: 'Loyalty points'.tr),
                        FooterView(
