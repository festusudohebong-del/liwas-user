        ...
        Container(
          ...
          child: SingleChildScrollView(
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              Text(
                'Amount can be convert into wallet money'.tr,
                style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor),
                ...
                return CustomButton(
                  ...
                  onPressed: () {
                    if(_amountController.text.isEmpty) {
                      ...
                      showCustomSnackBar('Input field is empty'.tr);
                    }else{
                      ...
                      if(amount <minimumExchangePoint!){
                        ...
                        showCustomSnackBar('${'Please exchange more then'.tr} $minimumExchangePoint ${'Points'.tr}');
                      }else if(point! < amount){
                        if(Get.isBottomSheetOpen!){
                          Get.back();
                        }
                        showCustomSnackBar('You do not have enough point to exchange'.tr);
                      } else {
