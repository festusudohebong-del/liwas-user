            ...
            Flexible(
              child: SingleChildScrollView(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                  ...
                  Text('${'Hey welcome back'.tr}\n${'Which location do you want to select'.tr}', style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
                  ...
                  Center(
                    child: addressController.addressList != null && addressController.addressList!.isEmpty ? Column(mainAxisSize: MainAxisSize.max,crossAxisAlignment: CrossAxisAlignment.center, children: [
                      ...
                      SizedBox(
                        width: 280,
                        child: Text(
                          'You dont have any saved address yet'.tr, textAlign: TextAlign.center,
                  ...
                  Align(
                    ...
                    child: TextButton.icon(
                      ...
                      label: Text('Use current location'.tr, style: fromDialog ? ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: addressController.addressList != null && addressController.addressList!.isEmpty
                          ? Theme.of(context).cardColor : Theme.of(context).primaryColor) : ralewayMedium.copyWith(color: addressController.addressList != null && addressController.addressList!.isEmpty
                          ? Theme.of(context).cardColor : Theme.of(context).primaryColor)),
                    ),
                  ),
                  ...
                  addressController.addressList != null && addressController.addressList!.isNotEmpty ? TextButton.icon(
                    ...
                    label: Text('Add new address'.tr, style: ralewayMedium.copyWith(color: Theme.of(context).primaryColor)),
                  ) : const SizedBox(),
