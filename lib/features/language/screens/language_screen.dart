...
import 'package:liwas_user/features/language/screens/web_language_screen.dart';
      ...
      body: GetBuilder<LocalizationController>(builder: (localizationController) {
        return ResponsiveHelper.isDesktop(context) ? const WebLanguageScreen() : Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
            ...
            child: Text('Choose your language'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
          ),
          const SizedBox(height: Dimensions.paddingSizeExtraSmall),

          Padding(
            padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeLarge),
            child: Text('Choose your language to proceed'.tr, style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
          ),
              ...
              child: CustomButton(
                ...
                onPressed: () {
                  if(localizationController.languages.isNotEmpty && localizationController.selectedLanguageIndex != -1) {
                    ...
                    showCustomSnackBar('Select a language'.tr);
                  }
                },
              ),
            ),
