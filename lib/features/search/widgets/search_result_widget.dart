...
import 'package:liwas_user/features/search/widgets/item_view_widget.dart';
      ...
      GetBuilder<search.SearchController>(builder: (searchController) {
        ...
        return isNull ? const SizedBox() : Center(child: SizedBox(width: Dimensions.webMaxWidth, child: Padding(
          ...
          child: Row(children: [
            Text(
              length.toString(),
              style: ralewayBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeSmall),
            ),
