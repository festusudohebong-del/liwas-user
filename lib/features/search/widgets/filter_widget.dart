          ...
          return SingleChildScrollView(
            child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Text('Filter'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                CustomButton(
                  onPressed: () {
                    if(isStore) {
              ...
              Text('Sort by'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
              ...
              Text('Filter by'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
              const SizedBox(height: Dimensions.paddingSizeSmall),
              ...
              CustomCheckBoxWidget(
                title: isStore ? Get.find<SplashController>().configModel!.moduleConfig!.module!.showRestaurantText!
                    ? 'Currently opened restaurants'.tr : 'Currently opened stores'.tr : 'Currently available items'.tr,
              ...
              CustomCheckBoxWidget(
                title: isStore ? Get.find<SplashController>().configModel!.moduleConfig!.module!.showRestaurantText!
                    ? 'Discounted restaurants'.tr : 'Discounted stores'.tr : 'Discounted items'.tr,
              ...
              isStore ? const SizedBox() : Column(children: [
                Text('Price'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                RangeSlider(
              ...
              Text('Rating'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
