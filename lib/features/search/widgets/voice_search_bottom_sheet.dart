  ...
  Future<void> _startListening() async {
    try {
      ...
      if (!(_searchController.voiceAvailable)) {
        showCustomSnackBar('Voice recognition not available'.tr);
      }
    } catch (e) {
      showCustomSnackBar('Voice input failed'.tr);
        ...
        child: Stack(children: [
          Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            AnimatedSwitcher(
              ...
              child: Text(
                isListening ? 'listening'.tr : 'Could not hear properly please try again'.tr,
            ...
            AnimatedContainer(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                AnimatedSwitcher(
                  duration: const Duration(milliseconds: 300),
                  child: Text(
                    recognizedText.isNotEmpty ? recognizedText : 'Tell me what you are looking for'.tr,
