...
import 'package:liwas_user/features/search/controllers/search_controller.dart' as search;
...
import 'package:liwas_user/helper/voice_permission_handler.dart';
...
import 'package:liwas_user/features/search/widgets/filter_widget.dart';
import 'package:liwas_user/features/search/widgets/search_field_widget.dart';
import 'package:liwas_user/features/search/widgets/search_result_widget.dart';
                ...
                child: SizedBox(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text('Search items and stores'.tr, style: ralewayMedium),
                      const SizedBox(height: Dimensions.paddingSizeDefault),
                      ...
                      SizedBox(width: Dimensions.webMaxWidth, child: GetBuilder<search.SearchController>(builder: (searchController) {
                        return SearchFieldWidget(
                          ...
                          hint: Get.find<SplashController>().configModel!.moduleConfig!.module!.showRestaurantText!
                              ? 'Search food or restaurant'.tr : 'Search item or store'.tr,
                            ...
                            children: [
                              Container(
                                ...
                                child: TabBar(
                                  ...
                                  unselectedLabelStyle: ralewayRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall),
                                  labelStyle: ralewayBold.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor),
                  ...
                  child: SizedBox(width: Dimensions.webMaxWidth, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    searchController.historyList.isNotEmpty ? Padding(
                      ...
                      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                        ...
                        Text(ResponsiveHelper.isDesktop(context) ? 'Recent searches'.tr : 'Your last search'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                        InkWell(
                          ...
                          child: Padding(
                            ...
                            child: Text('Clear all'.tr, style: ralewayRegular.copyWith(
                            ...
                            margin: const EdgeInsets.only(right: Dimensions.paddingSizeSmall),
                             padding: const EdgeInsets.symmetric(horizontal : Dimensions.paddingSizeDefault),
                              ...
                              child: InkWell(
                                ...
                                child: Row(
                                  children: [
                                    Text(searchController.historyList[index], style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).primaryColor), maxLines: 1, overflow: TextOverflow.ellipsis),
                                    const SizedBox(width: Dimensions.paddingSizeSmall),
                    ...
                    (_isLoggedIn && searchController.suggestedItemList != null && searchController.suggestedItemList!.isNotEmpty) ? Text(
                      'Suggestions'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                    ) : const SizedBox(),
                    ...
                    (searchController.popularCategoryList != null && searchController.popularCategoryList!.isNotEmpty) ? Text(
                      'Popular categories'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                    ) : const SizedBox(),
                    const SizedBox(height: Dimensions.paddingSizeSmall),
        ...
        child: SizedBox(
          ...
          child: foodsAndRestaurants.isNotEmpty ? ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              return ListTile(
                title: Text(foodsAndRestaurants[index], style: ralewayRegular,),
            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              ...
              Text('No suggestions found'.tr, style: ralewayMedium.copyWith(color: Theme.of(context).hintColor)),
            ]),
          ),
        ),
      ),
