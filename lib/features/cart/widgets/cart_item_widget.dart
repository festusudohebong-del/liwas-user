...
import 'package:liwas_user/common/widgets/item_bottom_sheet.dart';
                    ...
                    children: [
                      ...
                      widget.isAvailable ? const SizedBox() : Positioned(
                        ...
                        child: Container(
                          ...
                          child: Text('Not available now break'.tr, textAlign: TextAlign.center, style: ralewayRegular.copyWith(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        Padding(
                          ...
                          child: ((Get.find<SplashController>().configModel!.moduleConfig!.module!.unit! && widget.cart.item!.unitType != null && !Get.find<SplashController>().getModuleConfig(widget.cart.item!.moduleType).newVariation!)
                            ...
                            child: Text(
                              ...
                              style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeOverSmall, color: Theme.of(context).primaryColor),
                            ),
                          ) : const SizedBox(),
                        ),
                      ...
                      Wrap(children: [
                        Text(
                          ...
                          style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeSmall), textDirection: TextDirection.ltr,
                        ),
                      ...
                      widget.cart.item!.isPrescriptionRequired! ? Padding(
                        ...
                        child: Text(
                          ...
                          style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).colorScheme.error),
                        ),
                      ) : const SizedBox(),
                    ...
                    child: Column(children: [
                      ...
                      addOnText.isNotEmpty ? Padding(
                        ...
                        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text('${'Addons'.tr}: ', style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
                          Flexible(child: Text(
                            addOnText,
                      ...
                      variationText!.isNotEmpty ? Padding(
                        padding: const EdgeInsets.only(top: Dimensions.paddingSizeExtraSmall),
                        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text('${'Variations'.tr}: ', style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
                          Flexible(child: Text(
                            variationText,
                            style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor),
                          )),
