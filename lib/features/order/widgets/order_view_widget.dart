...
import 'package:liwas_user/features/order/widgets/order_shimmer_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<OrderController>(builder: (orderController) {
                              ...
                              Row(children: [
                                ...
                                Stack(children: [
                                  ...
                                  isParcel ? Positioned(left: 0, top: 10, child: Container(
                                    ...
                                    child: Text('Parcel'.tr, style: ralewayMedium.copyWith(
                                  ...
                                  isPrescription ? Positioned(left: 0, top: 10, child: Container(
                                    ...
                                    child: Text('Prescription'.tr, style: ralewayMedium.copyWith(
                                ...
                                Expanded(
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                    Row(children: [
                                      Text(
                                        '${isParcel ? 'Delivery id'.tr : 'Order id'.tr}:',
                                        style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall),
                                      ),
                                      const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                      Text('#${paginatedOrderModel.orders![index].id}', style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
                                    ]),
                                    ...
                                    ResponsiveHelper.isDesktop(context) ? Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: Text(paginatedOrderModel.orders![index].orderStatus!.tr, style: ralewayMedium.copyWith(
                                  ...
                                  isRunning ? InkWell(
                                    ...
                                    child: Container(
                                      ...
                                      child: Row(children: [
                                        ...
                                        const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                        Text(isParcel ? 'Track delivery'.tr : 'Track order'.tr, style: ralewayMedium.copyWith(
        ...
        ) : NoDataScreen(text: 'No order found'.tr, showFooter: true) : OrderShimmerWidget(orderController: orderController);
      }),
    );
  }
}
