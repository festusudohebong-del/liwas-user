...
import 'package:liwas_user/common/widgets/custom_divider.dart';
...
import 'package:liwas_user/features/order/widgets/address_details_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: (!takeAway && track.deliveryMan == null) ? Padding(
        padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
        child: Text(
          'Delivery man not assigned'.tr, style: ralewayMedium, textAlign: TextAlign.center,
        ),
      ) : Column(children: [

        Text('Trip route'.tr, style: ralewayMedium),
        ...
        Row(children: [
          ...
          Expanded(
            flex: 5,
            child: (takeAway && track.orderType != 'parcel') ? Text(track.store != null ? track.store!.address! : '', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall),
        ...
        Align(alignment: Alignment.centerLeft, child: Text(
          takeAway ? Get.find<SplashController>().configModel!.moduleConfig!.module!.showRestaurantText!
              ? 'Store'.tr : 'Store'.tr : 'Delivery man'.tr,
          ...
          InkWell(
            onTap: () async {
              if(await canLaunchUrlString('tel:${takeAway ? track.store != null ? track.store!.phone : '' : track.deliveryMan!.phone}')) {
                ...
                showCustomSnackBar('${'Can not launch'.tr} ${takeAway ? track.store != null ? track.store!.phone : '' : track.deliveryMan!.phone}');
              }
            },
            child: Container(
              ...
              child: Text(
                'Call'.tr,
                style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).cardColor),
              ),
            ),
          ),
          const SizedBox(width: Dimensions.paddingSizeSmall),
