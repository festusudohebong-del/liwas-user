                    ...
                    child: SingleChildScrollView(
                      ...
                      child: Column(mainAxisSize: MainAxisSize.min, children: [
                                    ...
                                    children: [
                                      Expanded(
                                        child: Text(
                                          ...
                                          style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeDefault, color: isSelected ? Theme.of(context).textTheme.bodyMedium!.color : Theme.of(context).textTheme.bodyMedium!.color!.withValues(alpha: 0.6)),
                                        ),
                                      ),
                        ...
                        !widget.fromChatPage ? Padding(
                          padding: const EdgeInsets.symmetric(vertical: Dimensions.paddingSizeDefault),
                          child: Text(
                            orderController.supportReasons != null && orderController.supportReasons!.isNotEmpty ? 'Or custom message'.tr : 'Custom message'.tr,
                        ...
                        !widget.fromChatPage ? CustomTextField(
                          ...
                          titleText: 'Type here to write a custom message'.tr,
                          showLabelText: false,
                          maxLines: 3,
