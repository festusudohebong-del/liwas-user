    ...
    return ResponsiveHelper.isDesktop(context) ? Expanded(
      ...
      child: Padding(
        ...
        child: Column(children: [
          ...
          CustomTextField(
            labelText: isOrder ? 'Order id'.tr : 'Trip id'.tr,
            titleText: isOrder ? 'Write order id'.tr : 'Write trip id'.tr,
            controller: _orderIdController,
            focusNode: _orderFocus,
            nextFocus: _phoneFocus,
            inputType: TextInputType.number,
          ...
          GetBuilder<OrderController>(builder: (orderController) {
            return GetBuilder<TaxiOrderController>(
              builder: (taxiOrderController) {
                return CustomButton(
                  buttonText: isOrder ? 'Track order'.tr : 'Track trip'.tr,
                  ...
                  onPressed: () async {
                    ...
                    if(orderId.isEmpty) {
                      showCustomSnackBar(isOrder ? 'Please enter order id'.tr : 'Please enter order id'.tr);
                    } else if (phone.isEmpty) {
                      showCustomSnackBar('Enter phone number'.tr);
                    }else if (!phoneValid.isValid) {
                      showCustomSnackBar('Invalid phone number'.tr);
