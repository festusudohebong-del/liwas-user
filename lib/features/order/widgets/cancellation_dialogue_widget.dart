          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Container(
              ...
              child: Column(children: [
                Text('Select cancellation reasons'.tr, style: ralewayMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeLarge)),
                        ...
                        return ListTile(
                          ...
                          title: Row(
                            children: [
                              ...
                              Flexible(child: Text(orderController.orderCancelReasons![index].reason!, style: ralewayRegular, maxLines: 3, overflow: TextOverflow.ellipsis)),
                            ],
                          ),
                        );
                      },
