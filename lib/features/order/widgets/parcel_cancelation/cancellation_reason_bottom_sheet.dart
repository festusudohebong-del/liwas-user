...
import 'package:liwas_user/features/order/widgets/parcel_cancelation/custom_check_box_widget.dart';
import 'package:liwas_user/features/order/widgets/parcel_cancelation/parcel_cancel_confirm_bottom_sheet.dart';
          ...
          child: Stack(children: [
            Padding(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                parcelController.parcelCancellationReasons != null && parcelController.parcelCancellationReasons!.isNotEmpty ? Text('Please select cancellation reason'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge)) : SizedBox(),
                ...
                CustomTextField(
                  ...
                  titleText: 'Type here your cancel reason'.tr,
                  showLabelText: false,
                  maxLines: 2,
                    ...
                    if(widget.isBeforePickup){
                      if((orderController.selectedParcelCancelReason != null && orderController.selectedParcelCancelReason!.isNotEmpty) || commentController.text.isNotEmpty) {
                        ...
                        if(orderController.selectedParcelCancelReason != null && orderController.selectedParcelCancelReason!.isNotEmpty){
                          showCustomSnackBar('You did not select any reason'.tr);
                        }else if(commentController.text.isNotEmpty){
                          showCustomSnackBar('You did not write any comment'.tr);
                        }
                      }
                    }else{
                      if((orderController.selectedParcelCancelReason != null && orderController.selectedParcelCancelReason!.isNotEmpty) || commentController.text.isNotEmpty) {
                ...
                Padding(
                  ...
                  child: InkWell(
                    ...
                    child: Center(
                      child: Text(
                        'Continue delivery'.tr,
                        style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge, decoration: TextDecoration.underline),
                      ),
                    ),
                  ),
                ),
