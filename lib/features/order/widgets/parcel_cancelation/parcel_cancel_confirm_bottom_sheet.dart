        ...
        child: Stack(children: [
          Padding(
            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              Text(
                'Return fare description'.tr, textAlign: TextAlign.center,
              ...
              Get.find<SplashController>().configModel?.parcelCancellationBasicSetup?.returnFeeStatus == '1' ? Text(
                ...
                style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeOverLarge),
              ) : SizedBox(),

              Get.find<SplashController>().configModel?.parcelCancellationBasicSetup?.returnFeeStatus == '1' ? Text(
                chargePayerSender ? 'Return fare'.tr : '${'Parcel delivery charge'.tr} + ${'Return fare'.tr}',
                textAlign: TextAlign.center,
                style: ralewayRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeLarge),
              ) : SizedBox(),
