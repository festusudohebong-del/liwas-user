...
import 'package:liwas_user/features/order/widgets/guest_custom_stepper_widget.dart';
import 'package:liwas_user/features/order/widgets/traking_map_widget.dart';
...
class _GuestTrackOrderScreenState extends State<GuestTrackOrderScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(title: 'Track order'.tr),
                  ...
                  Container(
                    ...
                    child: orderController.trackModel != null ? Column(children: [
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                        Text('Your order'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge)),

                        Text(' #${orderController.trackModel?.id}', style: ralewayMedium.copyWith(
                          ...
                          trailing: orderController.trackModel?.deliveryMan?.phone != null ? InkWell(
                            onTap: () async {
                              ...
                              if(await canLaunchUrlString('tel:${orderController.trackModel?.deliveryMan?.phone}')) {
                                ...
                                showCustomSnackBar('${'Can not launch'.tr} ${orderController.trackModel?.deliveryMan?.phone}');
                              }
