...
import 'package:liwas_user/features/rental_module/rental_order/widgets/trip_order_view_widget.dart';
...
import 'package:liwas_user/features/order/widgets/guest_track_order_input_view_widget.dart';
import 'package:liwas_user/features/order/widgets/order_view_widget.dart';
...
class OrderScreenState extends State<OrderScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: haveTaxiModule && !ResponsiveHelper.isDesktop(context) ? null : CustomAppBar(title: 'My orders'.tr, backButton: ResponsiveHelper.isDesktop(context)),
              ...
              children: [
                ...
                haveTaxiModule && !ResponsiveHelper.isDesktop(context) ? Container(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Text('My orders'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return Container(
                              ...
                              child: CustomInkWell(
                                ...
                                child: Text(type[index].tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: selected ? Colors.white : Theme.of(context).textTheme.bodyLarge!.color!.withValues(alpha: 0.7))),
                              ),
                            );
                          }),
                    ),
                    ...
                    ResponsiveHelper.isDesktop(context) ? Container(
                      ...
                      child: Column(children: [
                        ResponsiveHelper.isDesktop(context) ? Center(child: Padding(
                          ...
                          child: Text('My orders'.tr, style: ralewayMedium),
                        )) : const SizedBox(),
