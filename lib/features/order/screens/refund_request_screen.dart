...
class _RefundRequestScreenState extends State<RefundRequestScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: 'Refund request'.tr),
      body: SafeArea(
          ...
          return Center(
            child: orderController.refundReasons != null ? Container(
              ...
              child: Column(children: [
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      Container(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Text('Select refund reason'.tr, style: ralewayBold),
                          ...
                          Text('comments'.tr, style: ralewayBold),
                          const SizedBox(height: Dimensions.paddingSizeSmall),

                          CustomTextField(
                            controller: _noteController,
                            titleText: 'Type here your refund reason'.tr,
                            showLabelText: false,
                            maxLines: 3,
                      ...
                      Container(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Text('Add image'.tr, style: ralewayBold),
                          const SizedBox(height: Dimensions.paddingSizeSmall),
                                    ...
                                    child: orderController.refundImage != null ? GetPlatform.isWeb ? Image.network(
                                      ...
                                      child: Container(
                                        ...
                                        child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                                          ...
                                          Text('Upload image'.tr, style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor.withValues(alpha: 0.6))),
                                        ]),
                                      ),
                                    ),
                                  ),
                ...
                CustomButton(
                  buttonText: 'Submit refund request'.tr,
...
class SelectedCardWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Row(children: [
      ...
      Expanded(child: Text(title, style: ralewayRegular.copyWith(color: Theme.of(context).disabledColor), maxLines: 2, overflow: TextOverflow.ellipsis)),
