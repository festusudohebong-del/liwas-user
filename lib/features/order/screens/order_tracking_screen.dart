...
import 'package:liwas_user/helper/pusher_helper.dart';
...
import 'package:liwas_user/features/order/widgets/track_details_view_widget.dart';
import 'package:liwas_user/features/order/widgets/tracking_stepper_widget.dart';
...
class OrderTrackingScreenState extends State<OrderTrackingScreen> with WidgetsBindingObserver {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: 'Order tracking'.tr),
