...
import 'package:liwas_user/features/profile/widgets/web_profile_widget.dart';
                ...
                Expanded(
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text(
                      ...
                      style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge, color: Theme.of(context).cardColor),
                    ),
                    const SizedBox(height: Dimensions.paddingSizeExtraSmall),

                    isLoggedIn ? Text(
                      '${'Joined'.tr} ${DateConverter.containTAndZToUTCFormat(profileController.userInfoModel!.createdAt!)}',
                      style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).cardColor.withValues(alpha: 0.7)),
                    ) : InkWell(
                      onTap: () async {
            ...
            child: Container(
              ...
              child: Column(children: [
                ...
                isLoggedIn ? ProfileButtonWidget(
                  icon: Icons.delete, title: 'Delete account'.tr,
