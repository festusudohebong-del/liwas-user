...
import 'package:liwas_user/features/profile/widgets/profile_bg_widget.dart';
              ...
              child: Center(child: SizedBox(width: 1170, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Container(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Text('Basic information'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                    const SizedBox(height: Dimensions.paddingSizeLarge),

                    CustomTextField(
                      titleText: 'Enter name'.tr,
                      ...
                      labelText: 'Name'.tr,
                      required: true,
                      validator: (value) => ValidateCheck.validateEmptyText(value, "Please enter first name".tr),
                    ),
                    ...
                    Stack(children: [
                      ...
                      CustomTextField(
                        titleText: 'Write phone number'.tr,
                ...
                isLoggedIn && Get.find<SplashController>().configModel!.centralizeLoginSetup!.manualLoginStatus! ? Padding(
                  ...
                  child: ProfileButtonWidget(icon: Icons.lock, title: 'Change password'.tr, onTap: () {
            ...
            child: Container(
              ...
              child: Align(
                ...
                child: Padding(
                  ...
                  child: Text('Profile'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).cardColor)),
                ),
              ),
            ),
          ),
                      ...
                      child: SizedBox(
                        ...
                        child: Column(children: [
                          ...
                          CustomTextField(
                            ...
                            labelText: 'Name'.tr,
                            required: true,
                            validator: (value) => ValidateCheck.validateEmptyText(value, "First name field is required".tr),
                          ),
                          const SizedBox(height: Dimensions.paddingSizeExtraOverLarge),
