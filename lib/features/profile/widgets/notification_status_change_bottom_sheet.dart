      ...
      child: GetBuilder<AuthController>(builder: (authController) {
        return SafeArea(
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Text('Are you sure'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge), textAlign: TextAlign.center),
            const SizedBox(height: Dimensions.paddingSizeSmall),

            Padding(
              padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeLarge),
              child: Text(
                !authController.notification ? 'You want to enable notification'.tr : 'You want to disable notification'.tr,
                style: ralewayRegular.copyWith(color: Theme.of(context).hintColor), textAlign: TextAlign.center,
              ),
            ),
