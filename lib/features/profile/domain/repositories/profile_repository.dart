...
import 'package:liwas_user/features/profile/domain/models/update_profile_response_model.dart';
...
/*  @override
  Future<ResponseModel> delete(int? id) async {
    ...
    if (response.statusCode == 200) {
      responseModel = ResponseModel(true, 'Your account remove successfully'.tr);
    } else {
      responseModel = ResponseModel(false, response.statusText);
    }
    return responseModel;
