...
import 'package:liwas_user/features/menu/domain/models/menu_model.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return InkWell(
      onTap: () async {
        if(isLogout) {
          ...
          if(AuthHelper.isLoggedIn()) {
            Get.dialog(ConfirmationDialog(icon: Images.support, description: 'Are you sure to logout'.tr, isLogOut: true, onYesPressed: () {
      ...
      child: Column(children: [
        ...
        Text(menu.title, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall), textAlign: TextAlign.center),
