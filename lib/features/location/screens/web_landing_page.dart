...
import 'package:liwas_user/features/location/widgets/dynamic_text_color.dart';
...
import 'package:liwas_user/features/location/domain/models/prediction_model.dart';
...
import 'package:liwas_user/features/location/widgets/web_landing_page_shimmer_widget.dart';
...
import 'package:liwas_user/common/widgets/custom_loader.dart';
...
import 'package:liwas_user/features/location/widgets/landing_card_widget.dart';
import 'package:liwas_user/features/location/widgets/registration_card_widget.dart';
        ...
        builder: (splashController) {
          return splashController.landingModel == null ? const WebLandingPageShimmerWidget() : Column(children: [
            ...
            Container(
              ...
              child: Row(children: [
                ...
                Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text(splashController.landingModel?.fixedHeaderTitle ?? '', style: ralewayBold.copyWith(fontSize: 35)),
                  const SizedBox(height: Dimensions.paddingSizeLarge),
                        ...
                        onPressed: () async {
                          if(_address != null && _controller.text.trim().isNotEmpty) {
                            ...
                            if(response.isSuccess) {
                              ...
                              Get.back();
                              showCustomSnackBar('Service not available in current location'.tr);
                            }
                          }else {
                            showCustomSnackBar('Pick an address'.tr);
                          }
                        },
                      ),
                      const SizedBox(width: Dimensions.paddingSizeSmall),
            ...
            Text(
              ...
              style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).primaryColor),
            ),
            Text(
              splashController.landingModel?.fixedModuleSubTitle ?? '',
              style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).disabledColor),
            ),
            const SizedBox(height: 40),
                      ...
                      child: Row(children: [
                        Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Text(
                            ...
                            style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeDefault), textAlign: TextAlign.center,
                          ),
                          ...
                          Expanded(child: SingleChildScrollView(
                            ...
                            child: HtmlWidget(
                              ...
                              textStyle: ralewayRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.6)),
                              onTapUrl: (String url){
                              ...
                              child: MouseRegion(
                                ...
                                child: CustomToolTip(
                                  content: SizedBox(
                                    ...
                                    child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      Text(
                                        ...
                                        style: ralewayBold.copyWith(color: Theme.of(context).cardColor),
                                      ),
                                      const SizedBox(height: Dimensions.paddingSizeSmall),

                                      Text(
                                        modulesText.isEmpty ? 'No modules are available'.tr : '$modulesText ${'Modules are available'.tr}',
                                        style: ralewayRegular.copyWith(color: Theme.of(context).cardColor, fontSize: Dimensions.fontSizeSmall),
                                      ),
                                    ]),
                                  ),
                                  ...
                                  child: Container(
                                    ...
                                    child: Text(
                                      splashController.landingModel?.availableZoneList?[index].displayName ?? '',
                                      style: ralewayBold.copyWith(color: splashController.hoverStates[index] ? Theme.of(context).primaryColor :  Theme.of(context).textTheme.bodyMedium!.color!),
