...
import 'package:liwas_user/helper/marker_helper.dart';
                      ...
                      InkWell(
                        ...
                        child: Container(
                          ...
                          child: widget.fromStore ? Row(children: [
                            Expanded(
                              child: Text(widget.address.address ?? '', style: ralewayMedium, maxLines: 2, overflow: TextOverflow.ellipsis),
                            ),
                            ...
                            children: [
                              ...
                              Row(children: [
                                ...
                                Expanded(
                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.center, children: [
                                    ...
                                    Text(widget.address.addressType!.tr, style: ralewayRegular.copyWith(
                              ...
                              Text('- ${widget.address.contactPersonName}', style: ralewayMedium.copyWith(
                                color: Theme.of(context).primaryColor,
                                fontSize: Dimensions.fontSizeLarge,
                              )),

                              Text('- ${widget.address.contactPersonNumber}', style: ralewayRegular),
