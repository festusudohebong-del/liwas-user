...
import 'package:liwas_user/common/widgets/no_internet_screen.dart';
...
import 'package:liwas_user/features/location/screens/web_landing_page.dart';
...
class _AccessLocationScreenState extends State<AccessLocationScreen> {
  ...
  Widget build(BuildContext context) {
    return PopScope(
      ...
      child: Scaffold(
        appBar: CustomAppBar(title: 'Set location'.tr, backButton: widget.fromHome),
            ...
            return (ResponsiveHelper.isDesktop(context) && AddressHelper.getUserAddressFromSharedPref() == null) ? WebLandingPage(
              ...
              Expanded(child: SingleChildScrollView(
                child: FooterView(child: Column(mainAxisAlignment: (locationController.addressList != null && locationController.addressList!.isNotEmpty) ? MainAxisAlignment.start : MainAxisAlignment.center, children: [
                  ...
                  ) : NoDataScreen(text: 'No saved address found'.tr) : const Center(child: CircularProgressIndicator()),
              ...
              child: FooterView(child: SizedBox( width: 700,
                  child: Column(mainAxisAlignment: MainAxisAlignment.center,children: [
                    ...
                    Text('Find stores and items'.tr.toUpperCase(), textAlign: TextAlign.center, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeExtraLarge)),
                    Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeLarge),
                      child: Text('By allowing location access'.tr, textAlign: TextAlign.center,
...
class BottomButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Center(child: SizedBox(width: 700, child: Column(children: [
      ...
      CustomButton(
        buttonText: 'User current location'.tr,
        onPressed: () async {
      ...
      TextButton(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
          ...
          Text('Set from map'.tr, textAlign: TextAlign.center, style: ralewayBold.copyWith(
