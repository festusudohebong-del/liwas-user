          ...
          return ResponsiveHelper.isDesktop(context) ? Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text('Type your address here to pick form map'.tr, style: ralewayBold),
                const SizedBox(height: Dimensions.paddingSizeDefault),
                ...
                CustomButton(
                  ...
                  buttonText: locationController.inZone ? widget.fromAddAddress ? 'Pick address'.tr : 'Pick location'.tr
