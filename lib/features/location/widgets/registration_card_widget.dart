          ...
          Expanded(flex: 6, child: Padding(
            ...
            child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
              Text(
                ...
                style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeExtraLarge), textAlign: TextAlign.center,
              ),
              const SizedBox(height: Dimensions.paddingSizeLarge),
              Text(
                isStore ? splashController.landingModel!.joinSellerSubTitle ?? '' : splashController.landingModel!.joinDeliveryManSubTitle ?? '',
                style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall), textAlign: TextAlign.center,
              ),
