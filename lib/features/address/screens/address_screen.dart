...
import 'package:liwas_user/features/address/widgets/address_confirmation_dialogue.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<AddressController>(
      builder: (addressController) {
        return Scaffold(
          appBar: CustomAppBar(title: 'My address'.tr, backButton: widget.fromDashboard ? false : true),
                      ...
                      child: SizedBox(
                        ...
                        child: Column(
                          children: [
                                      ...
                                      child: CustomInkWell(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            Text('Add new address'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeSmall)),
                                          ],
                                        ),
                                      )
                                  ) :
                                  AddressWidget(
                                    ...
                                    onRemovePressed: () {
                                      ...
                                      Get.dialog(AddressConfirmDialogue(
                                          ...
                                          description: 'You want to delete this location'.tr,
                                          onYesPressed: () {
                            ...
                            ) : NoDataScreen(text: 'No saved address found'.tr, fromAddress: true) : const Center(child: CircularProgressIndicator()),
                          ],
                        ),
                      ),
                    ))
