...
import 'package:liwas_user/features/location/widgets/permission_dialog_widget.dart';
...
class _AddAddressScreenState extends State<AddAddressScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(title: widget.forGuest ? 'Set address'.tr : widget.address == null ? 'Add new address'.tr : 'Update address'.tr),
      body: SafeArea(
                  ...
                  child: Column(
                    children: [
                      Container(
                        ...
                        child: Center(child: Text('Address'.tr, style: ralewayMedium)),
                      ),
                              ...
                              Container(
                                ...
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    ...
                                    Text(
                                      'Label as'.tr,
                                      style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyMedium!.color),
                                    ),
                                            ...
                                            child: Row(
                                              children: [
                                                ...
                                                Text(index == 0 ? 'Home'.tr : index == 1 ? 'Office'.tr : 'Others'.tr,
                                                  style: ralewayRegular.copyWith(color: locationController.addressTypeIndex == index ? Theme.of(context).cardColor : Theme.of(context).disabledColor),
                                                )
                                              ],
                                            ),
                                          ),
                                    ...
                                    _otherSelect ? SizedBox (
                                      ...
                                      child: CustomTextField(
                                        titleText: '${'Level name'.tr}(${'Optional'.tr})',
                                        hintText: 'Write level name'.tr,
                                        showTitle: true,
                                    ...
                                    SizedBox(height: 90, width: 680,
                                      child: CustomTextField(
                                        ...
                                        showTitle: true,
                                        titleText: 'Delivery address'.tr,
                                        hintText: 'Write delivery address'.tr,
                                    ...
                                    child: Column(
                                      children: [
                                        ...
                                        CustomTextField(
                                          ...
                                          titleText: '${'Street number'.tr} (${'Optional'.tr})',
                                          showLabelText: false,
                                          inputType: TextInputType.streetAddress,
            ...
            : Column(children: [
              Expanded(child: SingleChildScrollView(
                ...
                child: Center(child: SizedBox(width: Dimensions.webMaxWidth, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Center(child: Text(
                    'Add the location correctly'.tr,
                    style: ralewayRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeExtraSmall),
                  )),
                  const SizedBox(height: Dimensions.paddingSizeLarge),
                  ...
                  _otherSelect ? CustomTextField(
                    labelText: '${'Level name'.tr}(${'Optional'.tr})',
                    titleText: 'Write level name'.tr,
                    inputType: TextInputType.text,
                    controller: _levelController,
                    focusNode: _levelNode,
                    nextFocus: _addressNode,
                  ...
                  CustomTextField(
                    labelText: widget.fromRide || (Get.find<SplashController>().module != null && Get.find<SplashController>().module!.moduleType.toString() == AppConstants.taxi) ? 'Pickup address'.tr : 'Delivery address'.tr,
                    titleText: 'Write delivery address'.tr,
                    inputType: TextInputType.streetAddress,
                    controller: _addressController,
                    focusNode: _addressNode,
                    nextFocus: _nameNode,
                  ...
                  CustomTextField(
                    labelText: '${'Street number'.tr} (${'Optional'.tr})',
                    titleText: 'Write street number'.tr,
                    inputType: TextInputType.streetAddress,
                    focusNode: _streetNode,
                    nextFocus: _houseNode,
                    controller: _streetNumberController,
                  ...
                  Row(children: [
                    Expanded(
                      child: CustomTextField(
                        ...
                        titleText: 'Write house number'.tr,
                        inputType: TextInputType.text,
                        focusNode: _houseNode,
                        nextFocus: _floorNode,
                        controller: _houseController,
                    ...
                    Expanded(
                      child: CustomTextField(
                        ...
                        titleText: 'Write floor number'.tr,
                        inputType: TextInputType.text,
                        focusNode: _floorNode,
                        inputAction: TextInputAction.done,
                        controller: _floorController,
  ...
  void _checkPermission(Function onTap) async {
    ...
    if(permission == LocationPermission.denied) {
      showCustomSnackBar('You have to allow'.tr);
      ...
      builder: (addressController) {
        return Container(
          ...
          child: CustomButton(
            ...
            buttonText: widget.forGuest ? 'Done'.tr : widget.address == null ? 'Save location'.tr : 'Update address'.tr,
  ...
  AddressModel? _prepareAddressModel(LocationController locationController, bool isValid, String numberWithCountryCode) {
    ...
    if(_addressController.text.isEmpty) {
      showCustomSnackBar('Please enter the delivery address'.tr);
    } else if(_contactPersonNameController.text.isEmpty) {
      showCustomSnackBar('Please enter the contact person name'.tr);
    } else if(_contactPersonNumberController.text.isEmpty) {
      showCustomSnackBar('Please enter the phone number'.tr);
    } else if (!isValid) {
  ...
  void _addAddress(AddressModel addressModel) {
    Get.find<AddressController>().addAddress(addressModel, widget.fromCheckout, widget.zoneId).then((response) {
      if(response.isSuccess && !widget.fromCheckout) {
        ...
        showCustomSnackBar('New address added successfully'.tr, isError: false);
