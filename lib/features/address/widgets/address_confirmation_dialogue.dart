            ...
            child: Column(mainAxisSize: MainAxisSize.min, children: [
              ...
              title != null ? Padding(
                ...
                child: Text(
                  ...
                  style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeExtraLarge, color: isDesktop ? Theme.of(context).textTheme.titleSmall!.color :Colors.red),
                ),
              ) : const SizedBox(),

              Padding(
                padding: const EdgeInsets.all(Dimensions.paddingSizeLarge),
                child: Text(description, style: isDesktop ? ralewayRegular.copyWith(fontSize: isDesktop ? Dimensions.fontSizeSmall : Dimensions.fontSizeLarge, color: Theme.of(context).hintColor) :
                       ralewayMedium.copyWith(fontSize: isDesktop ? Dimensions.fontSizeSmall : Dimensions.fontSizeLarge, color: Theme.of(context).hintColor), textAlign: TextAlign.center),
              ),
