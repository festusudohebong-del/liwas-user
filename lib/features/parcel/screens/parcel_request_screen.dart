...
import 'package:liwas_user/features/checkout/widgets/guest_create_account.dart';
import 'package:liwas_user/features/parcel/widgets/from_to_address_card.dart';
...
import 'package:liwas_user/features/payment/widgets/offline_payment_button.dart';
import 'package:liwas_user/features/checkout/widgets/payment_button.dart';
import 'package:liwas_user/features/checkout/widgets/tips_widget.dart';
import 'package:liwas_user/features/parcel/widgets/card_widget.dart';
import 'package:liwas_user/features/parcel/widgets/delivery_instruction_bottom_sheet_widget.dart';
...
class _ParcelRequestScreenState extends State<ParcelRequestScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(title: 'Parcel request'.tr),
              ...
              return Column(children: [
                ...
                Expanded(child: SingleChildScrollView(
                  ...
                  child: FooterView(child: SizedBox(width: Dimensions.webMaxWidth, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      ...
                      child: Container(
                        ...
                        child: Row(children: [
                          ...
                          Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Text(widget.parcelCategory.name!, style: ralewayBold.copyWith(color: Theme.of(context).primaryColor)),
                    ...
                    CardWidget(child: DetailsWidget(title: 'Sender details'.tr, address: widget.pickedUpAddress)),
                    const SizedBox(height: Dimensions.paddingSizeDefault),

                    CardWidget(child: DetailsWidget(title: 'Receiver details'.tr, address: widget.destinationAddress)),
                    const SizedBox(height: Dimensions.paddingSizeDefault),
                    ...
                    CardWidget(child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                      ...
                      Row(children: [
                        ...
                        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Text('Distance'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color!.withValues(alpha: 0.5))),
                        ]),
                      ]),
                      // const Spacer(),
                      ...
                      Row(children: [
                        ...
                        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text(
                            ...
                            style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).primaryColor), textDirection: TextDirection.ltr,
                          ),
                          Text('Delivery fee'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color!.withValues(alpha: 0.5))),
                        ]),
                      ])
                    ])),
                    const SizedBox(height: Dimensions.paddingSizeDefault),
                      ...
                      child: Padding(
                        ...
                        child: Column(children: [
                          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            Text("Add more delivery instruction".tr, style: ralewayMedium),
                            ...
                            Flexible(
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                                  ...
                                  children: [
                                    Flexible(
                                      child: Text(
                                        ...
                                        style: ralewayMedium.copyWith(color: Theme.of(context).primaryColor), maxLines: 1, overflow: TextOverflow.ellipsis,
                                      ),
                                    ),
                                    const SizedBox(width: Dimensions.paddingSizeSmall),
                                ...
                                parcelController.customNote!.isNotEmpty ? Text(
                                  ...
                                  style: ralewayMedium.copyWith(color: Theme.of(context).disabledColor),
                                ) : const SizedBox(),
                    ...
                    (Get.find<SplashController>().configModel!.dmTipsStatus == 1) ? CardWidget(
                      ...
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Text('Delivery man tips'.tr, style: ralewayMedium),
                        ...
                        SizedBox(
                          ...
                          child: (parcelController.selectedTips == AppConstants.tips.length-1) && parcelController.canShowTipsField ? const SizedBox() : ListView.builder(
                            ...
                            itemBuilder: (context, index) {
                              return TipsWidget(
                                title: AppConstants.tips[index] == '0' ? 'Not now'.tr : (index != AppConstants.tips.length -1)
                        ...
                        parcelController.selectedTips == AppConstants.tips.length-1 ? const SizedBox() : ListTile(
                          ...
                          title: Text('Save for later'.tr, style: ralewayMedium.copyWith(color: Theme.of(context).primaryColor)),
                              ...
                              onSubmit: (value) {
                                if(value.isNotEmpty){
                                  if(double.parse(value) >= 0) {
                                    ...
                                    showCustomSnackBar('Tips can not be negative'.tr);
                                  }
                                }else{
                    ...
                    Text('Charge pay by'.tr, style: ralewayMedium),
                    const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                    Row(children: [
                      Expanded(child: InkWell(
                        ...
                        child: Row(children: [
                          ...
                          Text(parcelController.payerTypes[0].tr, style: ralewayRegular),
                        ]),
                      )),
                      _isCashOnDeliveryActive! ? Expanded(child: InkWell(
                        ...
                        child: Row(children: [
                          ...
                          Text(parcelController.payerTypes[1].tr, style: ralewayRegular),
                        ]),
                      )) : const SizedBox(),
                    ]),
                    ...
                    Row(children: [
                      _isCashOnDeliveryActive! ? Expanded(
                        child: PaymentButton(
                          ...
                          subtitle: 'Pay your payment after getting item'.tr,
                      ...
                      (Get.find<SplashController>().configModel!.customerWalletStatus == 1 && parcelController.payerIndex == 0 && !isGuestLoggedIn) ? Expanded(
                        child: PaymentButton(
                          ...
                          subtitle: 'Pay from your existing balance'.tr,
                    ...
                    Text('Order summary'.tr, style: ralewayMedium),
                    const SizedBox(height: Dimensions.paddingSizeSmall),
                    ...
                    Row(children: [
                      ...
                      Text(
                        parcelController.distance == -1 ? 'Calculating'.tr : PriceConverter.convertPrice(charge),
                        style: ralewayRegular.copyWith(color: parcelController.distance == -1 ? Colors.red : Theme.of(context).textTheme.bodyMedium!.color),
                      ),
                    ]),
                    ...
                    (Get.find<SplashController>().configModel!.dmTipsStatus == 1) ? Row(
                      ...
                      children: [
                        ...
                        Text('(+) ${PriceConverter.convertPrice(dmTips)}', style: ralewayRegular, textDirection: TextDirection.ltr),
                      ],
                    ) : const SizedBox.shrink(),
                    ...
                    ((checkoutController.taxIncluded == null) || (checkoutController.taxIncluded == 1)) ? const SizedBox() : Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      ...
                      Text(('(+) ') + PriceConverter.convertPrice(checkoutController.orderTax), style: ralewayRegular, textDirection: TextDirection.ltr),
                    ]),
                    ...
                    Row(children: [
                      Text('Total amount'.tr, style: ralewayMedium),

                      checkoutController.taxIncluded == 1  ? Text(' ${'Vat tax inc'.tr}', style: ralewayMedium.copyWith(
                        fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).primaryColor,
                      )) : const SizedBox(),

                      const Expanded(child: SizedBox()),

                      PriceConverter.convertAnimationPrice(total, textStyle: ralewayMedium),
                    ]),
  ...
  Widget _bottomButton(ParcelController parcelController, double charge, {bool isGuestLoggedIn = false}) {
    ...
    return CustomButton(
      buttonText: 'Confirm parcel request'.tr,
      ...
      onPressed: parcelController.acceptTerms ? () {
        if(parcelController.distance == -1) {
          showCustomSnackBar('Delivery fee not set yet'.tr);
        }else if(parcelController.tips < 0) {
          showCustomSnackBar('Tips can not be negative'.tr);
        }else if(parcelController.paymentIndex == -1) {
          showCustomSnackBar('Please select payment method first'.tr);
