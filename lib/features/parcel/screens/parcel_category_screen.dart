...
import 'package:liwas_user/features/parcel/widgets/parcel_app_bar_widget.dart';
import 'package:liwas_user/features/parcel/widgets/deliver_item_card_widget.dart';
import 'package:liwas_user/features/parcel/widgets/get_service_video_widget.dart';
import 'package:liwas_user/features/parcel/widgets/sevice_info_list_widget.dart';
                ...
                child: FooterView(child: SizedBox(width: Dimensions.webMaxWidth,
                    child: Column(crossAxisAlignment: isDesktop ? CrossAxisAlignment.center : CrossAxisAlignment.start, children: [
                      ...
                      Padding(
                        ...
                        child: Text('What would you like to send'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                      ),
                      ...
                      ) : Center(child: Text('No parcel category found'.tr)) : ParcelShimmer(isEnabled: parcelController.parcelCategoryList == null, isDeliveryItem: true),
                      const SizedBox(height: Dimensions.paddingSizeLarge),
                      ...
                      Padding(
                        padding: EdgeInsets.symmetric(horizontal: isDesktop ? 0 : Dimensions.paddingSizeLarge),
                        child: Text('Experience the best with us'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                      ),
                      const SizedBox(height: Dimensions.paddingSizeSmall),
                      ...
                      Align(
                        ...
                        child: Padding(
                          padding: EdgeInsets.symmetric(horizontal: isDesktop ? 0 : Dimensions.paddingSizeLarge),
                          child: Text('Easiest way to get services'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                        ),
                      ),
                      const SizedBox(height: Dimensions.paddingSizeSmall),
