...
import 'package:liwas_user/features/location/widgets/serach_location_widget.dart';
...
import 'package:liwas_user/common/widgets/my_text_field.dart';
import 'package:liwas_user/common/widgets/text_field_shadow.dart';
        ...
        return Padding(
          ...
          child: Column(children: [
              ...
              Expanded(flex: 6,
                  child: InkWell(
                    ...
                    child: Container(
                      ...
                      child: Center(child: Text('Set from saved address'.tr, style: ralewayBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeLarge))),
                    ),
                  )
              ),
            ]),
            ...
            Column(children: [
              ...
              Center(child: Text('Receiver information'.tr, style: ralewayMedium)),
              const SizedBox(height: Dimensions.paddingSizeDefault),

              TextFieldShadow(
                child: MyTextField(
                  hintText: 'Receiver name'.tr,
              ...
              TextFieldShadow(
                child: MyTextField(
                  hintText: 'Receiver phone number'.tr,
            ...
            Column(children: [
              ...
              Center(child: Text('Destination information'.tr, style: ralewayMedium)),
              const SizedBox(height: Dimensions.paddingSizeDefault),

              TextFieldShadow(
                child: MyTextField(
                  hintText: "${'Street number'.tr} (${'Optional'.tr})",
