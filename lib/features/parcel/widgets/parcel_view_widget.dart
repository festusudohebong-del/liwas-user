...
import 'package:liwas_user/features/parcel/widgets/saved_address_bottom_sheet.dart';
            ...
            child: SizedBox(width: Dimensions.webMaxWidth, child: Column(children: [
              ...
              CustomCard(
                ...
                child: Column(children: [
                  ...
                  Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Text(widget.isSender ? 'Pickup location'.tr : 'Delivery location'.tr, style: ralewayMedium),
                    ...
                    addressController.addressList != null && addressController.addressList!.isNotEmpty && AuthHelper.isLoggedIn() ? InkWell(
                      ...
                      child: Row(
                        children: [
                          Text('Change address'.tr, style: ralewayBold.copyWith(
                      ...
                      label: Text('Select from map'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
                    ),
                  ]),
                        ...
                        builder: (context, controller, focusNode) {
                          return TextField(
                            ...
                            decoration: InputDecoration(
                              hintText: parcelController.isSender ?'Sender address'.tr : 'Receiver address'.tr,
              ...
              CustomCard(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  Text(parcelController.isSender ? 'Sender information'.tr : 'Receiver information'.tr, style: ralewayMedium),
                  const SizedBox(height: Dimensions.paddingSizeDefault),

                  CustomTextField(
                    labelText: parcelController.isSender ? 'Sender name'.tr : 'Receiver name'.tr,
                    titleText: parcelController.isSender ? 'Sender name'.tr : 'Receiver name'.tr,
                  ...
                  CustomTextField(
                    titleText: parcelController.isSender ? 'Sender phone number'.tr : 'Receiver phone number'.tr,
                    labelText: parcelController.isSender ? 'Sender phone number'.tr : 'Receiver phone number'.tr,
                  ...
                  AuthHelper.isGuestLoggedIn() ? CustomTextField(
                    titleText: parcelController.isSender ? 'Sender email'.tr : 'Receiver email'.tr,
                    labelText: parcelController.isSender ? 'Sender email'.tr : 'Receiver email'.tr,
