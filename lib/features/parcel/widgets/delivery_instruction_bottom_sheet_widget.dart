      ...
      return Container(
        ...
        child: parcelController.parcelInstructionList != null ? SingleChildScrollView(
          child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            parcelController.parcelInstructionList!.isNotEmpty ? Text("Choose delivery instructions".tr, style: ralewaySemiBold) : const SizedBox(),
            const SizedBox(height: Dimensions.paddingSizeDefault),
            ...
            Row(
              children: [
                parcelController.parcelInstructionList!.isNotEmpty ? Text("Or".tr, style: ralewaySemiBold) : const SizedBox(),
                SizedBox(width: parcelController.parcelInstructionList!.isNotEmpty ? Dimensions.paddingSizeExtraSmall : 0),

                Text("Add custom note".tr, style: ralewaySemiBold),
              ],
            ),
            const SizedBox(height: Dimensions.paddingSizeSmall),

            CustomTextField(
              titleText: "Type here your note".tr,
              showLabelText: false,
              maxLines: 3,
