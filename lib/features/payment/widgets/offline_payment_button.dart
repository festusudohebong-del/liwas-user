        ...
        child: Column(children: [
          Row(children: [
            ...
            Expanded(
              child: Text(
                'Pay offline'.tr,
                style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeDefault, color: disablePayment! ? Theme.of(context).disabledColor : Theme.of(context).textTheme.bodyLarge!.color),
            ...
            JustTheTooltip(
              ...
              content: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Text('Note'.tr, style: ralewayMedium.copyWith(color: const Color(0xff90D0FF))),
                    const SizedBox(height: Dimensions.paddingSizeSmall),

                    OfflinePaymentTooltipNoteWidget(
                      note: 'Offline payment note line one'.tr,
                    ),
                    const SizedBox(height: Dimensions.paddingSizeSmall),

                    OfflinePaymentTooltipNoteWidget(
                      note: 'Offline payment note line two'.tr,
                    ),
                    const SizedBox(height: Dimensions.paddingSizeSmall),

                    OfflinePaymentTooltipNoteWidget(
                      note: 'Offline payment note line three'.tr,
                    ),
                  ],
                ),
              ),
              ...
              return Container(
                ...
                child: CustomInkWell(
                  ...
                  child: Center(child: Text(offlineMethodList![index].methodName!,
                    style: ralewayMedium.copyWith(color: isSelected ? Theme.of(context).cardColor : Theme.of(context).textTheme.bodyMedium!.color!),
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        Expanded(child: Text(note, style: ralewayRegular.copyWith(color: Theme.of(context).cardColor))),
      ],
    );
  }
}
