...
import 'package:liwas_user/features/payment/domain/models/offline_method_model.dart';
...
class _OfflinePaymentScreenState extends State<OfflinePaymentScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(title: 'Offline payment'.tr),
      body: SafeArea(
                ...
                child: FooterView(
                  child: SizedBox(
                    ...
                    child: Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      Text('Pay your bill using the info'.tr, textAlign: TextAlign.center, style: ralewayRegular.copyWith(
    ...
    return Container(
      ...
      child: SingleChildScrollView(
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
          Row(children: [
            Text('Bank info'.tr, style: ralewayMedium.copyWith(color: Theme.of(context).primaryColor)),
            const Spacer(),

            selected ? Row(children: [
              Text('Pay on this account'.tr, style: ralewayMedium.copyWith(color: Theme.of(context).primaryColor),),
            ...
            return Padding(
              ...
              child: Row(children: [
                Text(
                  ...
                  style: ralewayMedium.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color!.withValues(alpha: 0.5)),
                ),
                Flexible(child: Text(offlineMethodList[index].methodFields![i].inputData!, style: ralewayMedium, overflow: TextOverflow.ellipsis)),
              ]),
            );
          })
