    ...
    return Scaffold(
      ...
      body: SafeArea(
        child: GetBuilder<CategoryController>(builder: (categoryController) {
          return categoryController.categoryList != null ? categoryController.categoryList!.isNotEmpty ? Center(
            child: Container(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text('Choose your interests'.tr, style: ralewayMedium.copyWith(fontSize: 22)),
                const SizedBox(height: Dimensions.paddingSizeSmall),

                Text('Get personalized recommendations'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).disabledColor)),
                const SizedBox(height: Dimensions.paddingSizeLarge),
          ...
          ) : NoDataScreen(text: 'No category found'.tr) : const Center(child: CircularProgressIndicator());
        }),
      ),
    );
  }
