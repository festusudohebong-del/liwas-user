...
import 'package:liwas_user/features/coupon/widgets/coupon_card_widget.dart';
      ...
      child: SingleChildScrollView(
        ...
        child: Column(children: [
          ...
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Text('Available promo'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
            IconButton(
              onPressed: ()=> Get.back(),
          ...
          GetBuilder<CouponController>(builder: (couponController) {
            ...
            return couponList != null ? couponList.isNotEmpty ? GridView.builder(
              ...
              Text(
                '${'Please add manually or collect promo from'.tr} ${Get.find<SplashController>().configModel!.businessName!}',
