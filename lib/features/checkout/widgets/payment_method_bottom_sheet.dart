      ...
      child: GetBuilder<CheckoutController>(builder: (checkoutController) {
        ...
        return Container(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Text('Choose payment method'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    ...
                    Text('Total bill'.tr, style: ralewayMedium.copyWith(fontSize: 14, color: Colors.grey.shade700)),
                    const SizedBox(height: Dimensions.paddingSizeExtraSmall),

                    Text(PriceConverter.convertPrice(widget.totalPrice), style: ralewayMedium.copyWith(fontSize: 20, color: Theme.of(context).primaryColor)),
                      ...
                      child: Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Text('Pay via online'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeDefault, color: disablePayments ? Theme.of(context).disabledColor : Theme.of(context).textTheme.bodyLarge!.color)),
                          ),
    ...
    return Column(children: [
          ...
          ? AnimatedOpacity(
              ...
              child: Container(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, spacing: Dimensions.paddingSizeExtraSmall, children: [
                  ...
                  Text('${'Change amount'.tr}(${Get.find<SplashController>().configModel?.currencySymbol})', style: ralewayBold.copyWith(
                    color: checkoutController.paymentMethodIndex == 0 ? Theme.of(context).textTheme.bodyLarge!.color : Theme.of(context).disabledColor,
                  )),

                  Text('Specify the amount of change the deliveryman needs to bring when delivering the order'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).disabledColor)),
                  const SizedBox(height: Dimensions.paddingSizeExtraSmall),
      ...
      if(checkoutController.paymentMethodIndex == 0)
        CustomInkWell(
          ...
          child: Text(showChangeAmount ? 'See less'.tr : 'See more'.tr , style: ralewayBold.copyWith(color: Colors.blue)),
        ),
      const SizedBox(height: Dimensions.paddingSizeSmall),
    ]);
  }
        ...
        child: Container(
          ...
          child: Row(children: [
            ...
            Expanded(
              child: Text(
                title,
                style: isDigitalPayment ? ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: disablePayments ? Theme.of(context).disabledColor : Theme.of(context).textTheme.bodyLarge!.color) :
                ralewaySemiBold.copyWith(fontSize: Dimensions.fontSizeDefault, color: disablePayments ? Theme.of(context).disabledColor : Theme.of(context).textTheme.bodyLarge!.color),
              ),
            ),
      ...
      Container(
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(isWalletSelected ? 'Wallet remaining balance'.tr : 'Wallet balance'.tr, style: ralewayMedium.copyWith(fontSize: 12, color: Colors.grey.shade700)),
            ...
            Row(children: [
              ...
              Text(
                ...
                style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).primaryColor),
              ),
            ])
          ]),
          ...
          CustomInkWell(
            ...
            child: isWalletSelected ? const Icon(Icons.clear, color: Colors.red) : Container(
              ...
              child: Text('Apply'.tr, style: ralewayMedium.copyWith(fontSize: 12, color: Theme.of(context).primaryColor)),
            ),
          ),
        ]),
      ),
      ...
      if(isWalletSelected && !checkoutController.isPartialPay)
        Container(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            Text('Paid by wallet'.tr, style: ralewayBold.copyWith(fontSize: 14)),
            Text(PriceConverter.convertPrice(widget.totalPrice), style: ralewayMedium.copyWith(fontSize: 18))
      ...
      if(isWalletSelected && checkoutController.isPartialPay)
        Column(children: [
          Container(
            ...
            child: Column(children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Text('Paid by wallet'.tr, style: ralewayMedium.copyWith(fontSize: 14, color: Colors.grey.shade700)),
                Text(PriceConverter.convertPrice(walletBalance), style: ralewayMedium.copyWith(fontSize: 14, color: Colors.grey.shade700))
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Text('Remaining bill'.tr, style: ralewayMedium.copyWith(fontSize: 14)),
                Text(PriceConverter.convertPrice(widget.totalPrice - walletBalance), style: ralewayBold.copyWith(fontSize: 18)),
          ...
          if(checkoutController.paymentMethodIndex == 1)
            Text('* ${'Please select a option to pay remain billing amount'.tr}', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: const Color(0xFFE74B4B))),
          const SizedBox(height: Dimensions.paddingSizeSmall),
        ]),
