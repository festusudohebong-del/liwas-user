...
import 'package:liwas_user/features/checkout/widgets/coupon_bottom_sheet.dart';
        ...
        return Container(
          ...
          child: Column(children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              Text('Promo code'.tr, style: ralewayMedium),
              InkWell(
                onTap: () {
                ...
                child: Padding(
                  ...
                  child: Row(children: [
                    Text('Add voucher'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor)),
                ...
                Expanded(
                  child: SizedBox(
                    ...
                    child: TextField(
                      ...
                      style: ralewayRegular.copyWith(height: ResponsiveHelper.isMobile(context) ? null : 2),
                ...
                InkWell(
                      ...
                      if(Get.find<CouponController>().discount! < 1 && !Get.find<CouponController>().freeDelivery) {
                        if(checkoutController.couponController.text.isNotEmpty && !Get.find<CouponController>().isLoading) {
                          Get.find<CouponController>().applyCoupon(checkoutController.couponController.text, (price-discount)+addOns + variationPrice, deliveryCharge,
                            ...
                            //checkoutController.couponController.text = 'Coupon applied'.tr;
                            if (discount! > 0) {
                              showCustomSnackBar(
                                '${'You got discount of'.tr} ${PriceConverter.convertPrice(discount)}',
                                isError: false,
                              );
                          ...
                          showCustomSnackBar('Enter a coupon code'.tr);
                        }
                      } else {
                  ...
                  child: Container(
                    ...
                    child: (couponController.discount! <= 0 && !couponController.freeDelivery) ? !couponController.isLoading ? Text(
                      'Apply'.tr,
                      style: ralewayMedium.copyWith(color: Theme.of(context).cardColor),
                    ) : const SizedBox(
                      height: 30, width: 30,
