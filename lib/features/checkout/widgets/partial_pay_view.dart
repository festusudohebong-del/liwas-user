          ...
          child: ResponsiveHelper.isDesktop(context) ?  Row(children: [
            ...
            InkWell(
              ...
              child: Container(
                ...
                child: Text(
                  ...
                  style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeDefault, color: checkoutController.isPartialPay || checkoutController.paymentMethodIndex == 1 ? Colors.red : Colors.white),
                ),
              ),
            ),
            ...
            Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text(
                  checkoutController.isPartialPay ? 'Has paid by your wallet'.tr : 'Your have balance in your wallet'.tr,
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              checkoutController.isPartialPay || checkoutController.paymentMethodIndex == 1 ? Row(children: [
                ...
                Text(
                  'Applied'.tr,
                  style: ralewayMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeLarge),
                )
              ]) : Text(
                'Do you want to use now'.tr,
                style: ralewayMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeLarge),
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Text(
                    checkoutController.isPartialPay || checkoutController.paymentMethodIndex == 1 ? 'Remove'.tr : 'Use'.tr,
                    style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: checkoutController.isPartialPay || checkoutController.paymentMethodIndex == 1 ? Colors.red : Colors.white),
                  ),
                ),
              ),
