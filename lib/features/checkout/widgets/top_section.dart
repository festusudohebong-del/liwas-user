...
import 'package:liwas_user/features/cart/widgets/delivery_option_button_widget.dart';
import 'package:liwas_user/features/checkout/widgets/coupon_section.dart';
import 'package:liwas_user/features/checkout/widgets/delivery_instruction_view.dart';
import 'package:liwas_user/features/checkout/widgets/delivery_section.dart';
import 'package:liwas_user/features/checkout/widgets/deliveryman_tips_section.dart';
import 'package:liwas_user/features/checkout/widgets/payment_section.dart';
import 'package:liwas_user/features/checkout/widgets/time_slot_section.dart';
import 'package:liwas_user/features/checkout/widgets/web_delivery_instruction_view.dart';
import 'package:liwas_user/features/store/widgets/camera_button_sheet_widget.dart';
import 'dart:io';
      ...
      child: Column(children: [
        ...
        storeId != null ? Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              Text('Your prescription'.tr, style: ralewayMedium),
              ...
              JustTheTooltip(
                ...
                content: Padding(
                  ...
                  child: Text('Prescription tool tip'.tr, style: ralewayRegular.copyWith(color: Colors.white)),
                ),
                child: InkWell(
                      ...
                      child: DottedBorder(
                        ...
                        child: Container(
                          ...
                          child:  Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            Text('Upload your prescription'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall), textAlign: TextAlign.center,),
                          ]),
                        ),
                      ),
                    );
        ...
        Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start,
            children: [
              Text('Delivery type'.tr, style: ralewayMedium),
              const SizedBox(height: Dimensions.paddingSizeSmall),

              storeId != null ? DeliveryOptionButtonWidget(
                value: 'delivery', title: 'Home delivery'.tr, charge: charge,
                ...
                Get.find<SplashController>().configModel!.takeawayStatus == 1 && checkoutController.store!.takeAway! ? DeliveryOptionButtonWidget(
                  value: 'take_away', title: 'Take away'.tr, charge: deliveryCharge, isFree: true,  fromWeb: true, total: total,
                  deliveryChargeForView: deliveryChargeForView, badWeatherCharge: badWeatherCharge, extraChargeForToolTip: extraChargeForToolTip,
                ) : const SizedBox(),
              ]),
              ),
