                ...
                Row(children: [
                  ...
                  JustTheTooltip(
                    ...
                    content: Padding(
                      ...
                      child: Text('It s a great way to show your appreciation for their hard work'.tr,style: ralewayRegular.copyWith(color: Colors.white)),
                    ),
                    child: InkWell(
                ...
                SizedBox(
                  ...
                  ? const SizedBox() : ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return TipsWidget(
                        title: AppConstants.tips[index] == '0' ? 'Not now'.tr : (index != AppConstants.tips.length -1) ? PriceConverter.convertPrice(double.parse(AppConstants.tips[index].toString()), forDM: true) : AppConstants.tips[index].tr,
                      ...
                      onChanged: (String value) async {
                        if(value.isNotEmpty) {
                          try {
                            ...
                            showCustomSnackBar('Invalid input'.tr);
