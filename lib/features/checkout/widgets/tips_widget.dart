    ...
    return Padding(
      ...
      child: Column(children: [
          ...
          child: Container(
            ...
            child: Column(children: [
              ...
              isSuggested && ResponsiveHelper.isDesktop(context) ? Container(
                ...
                child: Text(
                  'Most tipped'.tr, style: ralewayRegular.copyWith(color: Colors.white, fontSize: Dimensions.fontSizeOverSmall),
                ),
        ...
        isSuggested && !ResponsiveHelper.isDesktop(context) ? Text(
          'Most tipped'.tr, style: ralewayMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeExtraSmall),
        ) : const SizedBox(),
      ]),
    );
  }
