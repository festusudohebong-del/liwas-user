          ...
          child: SingleChildScrollView(
            child: Column(children: [
              ...
              RichText(textAlign: TextAlign.center, text: TextSpan(children: [
                TextSpan(text: 'Your payment has been successfully processed and your order'.tr, style: ralewayMedium.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color!.withValues(alpha: 0.4))),
                TextSpan(text: ' #$orderId ', style: ralewayBold.copyWith(color: Theme.of(context).primaryColor)),
                TextSpan(text: 'Has been placed'.tr, style: ralewayMedium.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color!.withValues(alpha: 0.4))),
              ])),
              const SizedBox(height: Dimensions.paddingSizeLarge),
                  ...
                  return Container(
                    ...
                    child: orderController.trackModel != null ? ListView.builder(
                      ...
                      return Padding(
                        ...
                        child: Row(children: [
                          Text('${data.userInput.toString().replaceAll('_', ' ')}: ', style: ralewayMedium),
                          Text(data.userData.toString(), style: ralewayMedium),
                        ]),
                      );
                    }) : const SizedBox(),
                  );
              ...
              RichText(textAlign: TextAlign.center, text: TextSpan(children: [
                TextSpan(text: '*', style: ralewayMedium.copyWith(color: Colors.red)),
                TextSpan(text: 'Offline order note'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).disabledColor)),
              ])),
              const SizedBox(height: Dimensions.paddingSizeDefault),
