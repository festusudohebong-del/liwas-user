...
import 'package:liwas_user/features/checkout/widgets/guest_delivery_address.dart';
      ...
      isGuestLoggedIn ? GuestDeliveryAddress(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Text('Deliver to'.tr, style: ralewayMedium),
            TextButton.icon(
              onPressed: () async {
              ...
              label: Text('Add new'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
            ),
          ]),
                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  crossAxisAlignment: CrossAxisAlignment.start,
                                  children: [
                                    Text(address[index].addressType!.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
