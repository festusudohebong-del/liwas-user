        ...
        children: [
          ...
          RichText(
            ...
            text: TextSpan(children: [
              TextSpan(text: 'You got'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color)),
              const TextSpan(text: ' '),

              TextSpan(text: PriceConverter.convertPrice(extraDiscount), style: ralewayBold.copyWith(color: Theme.of(context).textTheme.bodyMedium!.color)),
              const TextSpan(text: ' '),

              TextSpan(
                text: 'Additional discount'.tr,
