...
import 'package:liwas_user/features/checkout/widgets/time_slot_bottom_sheet.dart';
    ...
    return Column(children: [
      !isGuestLoggedIn && storeId == null && checkoutController.store!.scheduleOrder! && cartList!.isNotEmpty && cartList![0]!.item!.availableDateStarts == null ? Container(
        ...
        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Row(children: [
            Text('Preference time'.tr, style: ralewayMedium),
            ...
            JustTheTooltip(
              ...
              content: Padding(
                ...
                child: Text('Schedule time tool tip'.tr,style: ralewayRegular.copyWith(color: Colors.white)),
              ),
              child: InkWell(
              ...
              child: Row(children: [
                ...
                Expanded(
                  child: ((checkoutController.selectedDateSlot == 0 && todayClosed) || (checkoutController.selectedDateSlot == 1 && tomorrowClosed))
                    ? Center(child: Text(module!.showRestaurantText! ? 'Restaurant is closed'.tr : 'Store is closed'.tr))
