...
import 'package:liwas_user/features/checkout/widgets/prescription_view_dialog_widget.dart';
    ...
    return storeId == null &&
        ...
        ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            Row(children: [
              ...
              const SizedBox(width: Dimensions.paddingSizeExtraSmall),
              CustomToolTip(
                message: 'Upload jpg png jpeg maximum 2 MB'.tr,
            ...
            isPrescriptionRequired
                ? Container(
                    ...
                    child: Text(
                      'Prescription required for this order because you have a item that need prescription'
                          .tr,
