...
import 'package:liwas_user/features/notification/widgets/notification_bottom_sheet.dart';
...
import 'package:liwas_user/features/notification/widgets/notification_dialog_widget.dart';
    ...
    return PopScope(
      ...
      child: Scaffold(
        ...
        body: AuthHelper.isLoggedIn() ? GetBuilder<NotificationController>(builder: (notificationController) {
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            addTitle ? Padding(
                              ...
                              child: Text(
                                ...
                                style: ralewayMedium.copyWith(color: Theme.of(context).hintColor),
                              ),
                            ) : const SizedBox(),
                                    ...
                                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      ...
                                      Expanded(
                                        child: Text(
                                          ...
                                          style: ralewayBold.copyWith(color: isSeen ? Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.5) : Theme.of(context).textTheme.bodyLarge?.color,
                                      ...
                                      Padding(
                                        ...
                                        child: Text(
                                          ...
                                          style: ralewayRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge?.color, fontSize: Dimensions.fontSizeSmall),
                                        ),
                                      ),
                                    ...
                                    Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                      Expanded(
                                        child: Text(
                                          ...
                                          style: ralewayRegular.copyWith(color: isSeen ? Theme.of(context).disabledColor : Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.7)),
                                        ),
                                      ),
                                      const SizedBox(width: Dimensions.paddingSizeSmall),
          ...
          ) : NoDataScreen(text: 'No notification found'.tr, showFooter: true) : const Center(child: CircularProgressIndicator());
