          ...
          child: SingleChildScrollView(
            child: Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text(notificationModel.data?.title ?? '', style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                const SizedBox(height: Dimensions.paddingSizeExtraSmall),

                Text(notificationModel.data?.description ?? '', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
