      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Padding(
          ...
          child: Column(children: [
            Align(alignment: Alignment.centerLeft, child: Text('How it works'.tr , style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge), textAlign: TextAlign.center)),
              ...
              itemBuilder: (context, index){
                return Padding(
                  ...
                  child: Row(children: [
                    ...
                    Text(AppConstants.dataList[index].tr, style: ralewayRegular),
