...
class _HtmlViewerScreenState extends State<HtmlViewerScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: widget.htmlType == HtmlType.termsAndCondition ? 'Terms conditions'.tr
          : widget.htmlType == HtmlType.aboutUs ? 'About us'.tr : widget.htmlType == HtmlType.privacyPolicy
          ? 'Privacy policy'.tr : widget.htmlType == HtmlType.shippingPolicy ? 'Shipping policy'.tr
          : widget.htmlType == HtmlType.refund ? 'Refund policy'.tr :  widget.htmlType == HtmlType.cancellation
          ? 'Cancellation policy'.tr : 'No data found'.tr),
      ...
      body: GetBuilder<HtmlController>(builder: (htmlController) {
        return Center(
          child: htmlController.htmlText != null ? SingleChildScrollView(
            ...
            child: Column(
              children: [
                WebScreenTitleWidget( title: widget.htmlType == HtmlType.termsAndCondition ? 'Terms conditions'.tr
                  : widget.htmlType == HtmlType.aboutUs ? 'About us'.tr : widget.htmlType == HtmlType.privacyPolicy
                  ? 'Privacy policy'.tr : widget.htmlType == HtmlType.shippingPolicy ? 'Shipping policy'.tr
                  : widget.htmlType == HtmlType.refund ? 'Refund policy'.tr :  widget.htmlType == HtmlType.cancellation
                  ? 'Cancellation policy'.tr : 'No data found'.tr),
