...
import 'package:liwas_user/features/wallet/widgets/bonus_banner_widget.dart';
...
import 'package:liwas_user/features/wallet/widgets/wallet_card_widget.dart';
import 'package:liwas_user/features/wallet/widgets/wallet_history_widget.dart';
import 'package:liwas_user/features/wallet/widgets/web_bonus_banner_widget.dart';
      ...
      if((widget.fundStatus == 'success' || widget.fundStatus == 'fail' || widget.fundStatus == 'cancel') && Get.find<WalletController>().getWalletAccessToken() != widget.token){
        Future.delayed(const Duration(seconds: 2), () {
          ...
          Get.showSnackbar(GetSnackBar(
            ...
            message: widget.fundStatus == 'success' ? 'Fund successfully added to wallet'.tr : 'Fund not added to wallet'.tr,
            maxWidth: 500,
