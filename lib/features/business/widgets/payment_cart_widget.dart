      ...
      return Stack( clipBehavior: Clip.none, children: [
        ...
        InkWell(
          ...
          child: Container(
            ...
            child: Row(children: [
              Text(title, style: ralewayBold.copyWith(color: businessController.paymentIndex == index ? Theme.of(context).primaryColor : Theme.of(context).textTheme.bodyLarge!.color)),
              const Spacer(),
