...
import 'package:liwas_user/features/business/domain/models/package_model.dart';
import 'package:liwas_user/features/business/widgets/curve_clipper_widget.dart';
import 'package:liwas_user/features/business/widgets/package_widget.dart';
        ...
        Positioned(
          ...
          child: Column(children: [
            ...
            Text(
              ...
              style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: canSelect ? Theme.of(context).cardColor : Colors.cyan.shade700),
            ),
            const SizedBox(height: Dimensions.paddingSizeSmall),

            Text(
              PriceConverter.convertPrice(packages.price),
              style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeOverLarge, color: canSelect ? Theme.of(context).cardColor : Colors.cyan.shade700),
            ),

            Text('${packages.validity}' 'Days'.tr, style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: canSelect ? Theme.of(context).cardColor : Theme.of(context).textTheme.bodyLarge?.color?.withValues(alpha: 0.7))),
            ...
            Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              PackageWidget(title: '${isRental ? 'Max trip'.tr : 'Max order'.tr} (${packages.maxOrder})', isSelect: canSelect ? true : false),

              PackageWidget(title: '${isRental ? 'Max vehicle'.tr : 'Max product'.tr} (${packages.maxProduct})', isSelect: canSelect ? true : false),

              packages.pos == 1 ? PackageWidget(title: 'Pos'.tr, isSelect: canSelect ? true : false) : const SizedBox(),

              packages.mobileApp == 1 ? PackageWidget(title: 'Mobile app'.tr, isSelect: canSelect ? true : false) : const SizedBox(),
              ...
              packages.selfDelivery == 1 ? PackageWidget(title: 'Self delivery'.tr, isSelect: canSelect ? true : false) : const SizedBox(),
