                      ...
                      children: [
                        ...
                        (itemController.item!.description != null && itemController.item!.description!.isNotEmpty) ? Column(
                          ...
                          children: [
                            ...
                            Text('Description'.tr, style: ralewayBold),
                            ...
                            itemController.item!.description!.length > 150 ? InkWell(
                              ...
                              child: Text(
                                itemController.isReadMore ? "Read less".tr : "Read more".tr,
                                style: ralewayRegular.copyWith(color: Theme.of(context).primaryColor),
                              ),
                            ) : const SizedBox(),
                        ...
                        (itemController.item!.nutritionsName != null && itemController.item!.nutritionsName!.isNotEmpty) ? Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Nutrition details'.tr, style: ralewayBold),
                            const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                        ...
                        (itemController.item!.allergiesName != null && itemController.item!.allergiesName!.isNotEmpty) ? Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Text('Allergic ingredients'.tr, style: ralewayBold),
                            const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                        ...
                        ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              ...
                              Row(
                                children: [
                                  Text(itemController.item!.choiceOptions![index].title!, style: ralewayBold),
                                  Text(' (${'Select one'.tr})', style: ralewayRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeExtraSmall)),
                                ],
                              ),
                              const SizedBox(height: Dimensions.paddingSizeSmall),
                        ...
                        GetBuilder<CartController>(builder: (cartController) {
                          return Row(children: [
                            Text('${'Total amount'.tr}:', style: ralewayBold),
                            ...
                            Text(PriceConverter.convertPrice(itemController.cartIndex != -1
                                ...
                                : priceWithAddOns), textDirection: TextDirection.ltr, style: ralewayBold.copyWith(
                            ...
                            builder: (cartController) {
                              return CustomButton(
                                ...
                                buttonText: (Get.find<SplashController>().configModel!.moduleConfig!.module!.stock! && stock! <= 0) ? 'Out of stock'.tr
                                    : itemController.item!.availableDateStarts != null ? 'Order now'.tr : itemController.cartIndex != -1 ? 'Update in cart'.tr : 'Add to cart'.tr,
