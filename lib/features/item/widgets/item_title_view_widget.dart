...
class ItemTitleViewWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    if (kDebugMode) {
      print(inStock ? 'Out of stock'.tr : 'In stock'.tr);
    }
      ...
      return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            child: Row(
              children: [
                Flexible(
                  child: Text(
                    item?.name ?? '',
                    style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeOverLarge),
                ...
                || (Get.find<SplashController>().configModel!.moduleConfig!.module!.vegNonVeg! && Get.find<SplashController>().configModel!.toggleVegNonVeg!)) ? Text(
                  Get.find<SplashController>().configModel!.moduleConfig!.module!.unit! ? '(${item!.unitType})'
                      : item!.veg == 0 ? '(${'Non veg'.tr})' : '(${'Veg'.tr})',
                  style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor),
                ) : const SizedBox(),
              ],
            ),
          ),
        ...
        Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
          Container(
            ...
            child: Text(inStock ? 'Out of stock'.tr : 'In stock'.tr, style: ralewayRegular.copyWith(
        ...
        Row(children: [
          ...
          Text(
            ...
            style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge), textDirection: TextDirection.ltr,
          ),
        ]),
            ...
            Row(crossAxisAlignment: CrossAxisAlignment.end, children: [
              Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text(
                  '${PriceConverter.convertPrice(startingPrice, discount: discount, discountType: discountType)}'
                      '${endingPrice!= null ? ' - ${PriceConverter.convertPrice(endingPrice, discount: discount, discountType: discountType)}' : ''}',
                  style: ralewayMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeLarge), textDirection: TextDirection.ltr,
                ),
                const SizedBox(height: 5),
                ...
                discount! > 0 ? Text(
                  ...
                  style: ralewayRegular.copyWith(color: Theme.of(context).hintColor, decoration: TextDecoration.lineThrough),
                ) : const SizedBox(),
                SizedBox(height: discount > 0 ? 5 : 0),

                !isCampaign ? Row(children: [
                  Text(item!.avgRating!.toStringAsFixed(1), style: ralewayRegular.copyWith(
