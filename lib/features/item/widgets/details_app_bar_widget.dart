...
class DetailsAppBarWidgetState extends State<DetailsAppBarWidget> with SingleTickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    ...
    return AppBar(
      ...
      title: Text(
        'Item details'.tr,
        style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).textTheme.bodyLarge!.color),
      ),
      centerTitle: true,
                ...
                child: Container(
                  ...
                  child: GetBuilder<CartController>(builder: (cartController) {
                    return Text(
                      ...
                      style: ralewayMedium.copyWith(color: Colors.white, fontSize: 8),
                    );
                  }),
                ),
              ),
