...
import 'package:liwas_user/features/item/domain/models/basic_medicine_model.dart';
import 'package:liwas_user/features/cart/domain/models/cart_model.dart';
import 'package:liwas_user/features/item/domain/models/common_condition_model.dart';
...
class ItemController extends GetxController implements GetxService {
  ...
  void setNewCartVariationIndex(int index, int i, Item item) {
    ...
    //     showCustomSnackBar(
    //       '${'Maximum variation for'.tr} ${item.foodVariations![index].name} ${'Is'.tr} ${item.foodVariations![index].max}',
    //       getXSnackBar: true,
    //     );
    //   }else {
