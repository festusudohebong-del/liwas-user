...
import 'package:liwas_user/common/widgets/cart_snackbar.dart';
...
import 'package:liwas_user/features/item/widgets/details_app_bar_widget.dart';
import 'package:liwas_user/features/item/widgets/details_web_view_widget.dart';
import 'package:liwas_user/features/item/widgets/item_image_view_widget.dart';
import 'package:liwas_user/features/item/widgets/item_title_view_widget.dart';
                  ...
                  children: [
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          Text(item.choiceOptions![index].title!, style:ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                    ...
                    GetBuilder<CartController>(
                      builder: (cartController) {
                        return Row(children: [
                          Text('Quantity'.tr, style:ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                    ...
                    Row(children: [
                      Text('${'Total amount'.tr}:', style:ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                      ...
                      Text(
                        ...
                        style:ralewayBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeLarge),
                      ),
                    ]),
                    ...
                    item.isPrescriptionRequired! ? Container(
                      ...
                      child: Text(
                        ...
                        style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).colorScheme.error),
                      ),
                    ) : const SizedBox(),
                    ...
                    (item.description != null && item.description!.isNotEmpty) ? Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Description'.tr, style: ralewayMedium),
                        const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                        Text(item.description!, style: ralewayRegular),
                        const SizedBox(height: Dimensions.paddingSizeLarge),
                      ],
                    ) : const SizedBox(),
                    ...
                    (item.nutritionsName != null && item.nutritionsName!.isNotEmpty) ? Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Nutrition details'.tr, style: ralewayMedium),
                        const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                    ...
                    (item.allergiesName != null && item.allergiesName!.isNotEmpty) ? Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('Allergic ingredients'.tr, style: ralewayMedium),
                        const SizedBox(height: Dimensions.paddingSizeExtraSmall),
              ...
              builder: (cartController) {
                return Container(
                  ...
                  child: CustomButton(
                    ...
                    buttonText: (Get.find<SplashController>().configModel!.moduleConfig!.module!.stock! && stock! <= 0) ? 'Out of stock'.tr
                        : item.availableDateStarts != null ? 'Order now'.tr : itemController.cartIndex != -1 ? 'Update in cart'.tr : 'Add to cart'.tr,
        ...
        if(isExistInCart) {
          if (!isIncrement && quantity! > 1) {
            ...
            if(quantity! < stock! || !Get.find<SplashController>().configModel!.moduleConfig!.module!.stock!) {
              ...
              showCustomSnackBar('Out of stock'.tr);
            }
          }
        } else {
          if (!isIncrement && quantity! > 1) {
