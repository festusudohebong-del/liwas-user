...
import 'package:liwas_user/common/widgets/cart_count_view.dart';
...
import 'package:liwas_user/common/widgets/organic_tag.dart';
            ...
            child: Column(children: [
                ...
                child: Row(children: [
                  ...
                  Expanded(child: Container(
                    ...
                    child: SearchFieldWidget(
                      ...
                      isFocused: false,
                      radius: 50,
                      hint: 'Search your desired item'.tr,
                      ...
                      iconPressed: () {
                        if (!itemController.isSearching) {
                          if (itemController.searchController.text.trim().isNotEmpty) {
                            ...
                            showCustomSnackBar('Write item name for search'.tr);
                          }
                        } else {
              ...
              Padding(
                ...
                child: Row(children: [
                  ...
                  Text(widget.isPopular ? isShop ? 'Most popular products'.tr : 'Most popular items'.tr : widget.isSpecial ? 'Special offer'.tr : 'Best reviewed item'.tr, style: ralewayBold),
                  Text(' (${itemController.pageSize ?? 0})', style: ralewayBold),
                  const Spacer(),
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              child: Stack(children: [
                ...
                (item.stock != null && item.stock! < 0) ? Positioned(
                  ...
                  child: Container(
                    ...
                    child: Text('Out of stock'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).cardColor, fontSize: Dimensions.fontSizeSmall)),
                  ),
                ) : const SizedBox(),
            ...
            Expanded(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                ...
                Flexible(child: Text(item.name ?? '', style: ralewayBold, maxLines: 1, overflow: TextOverflow.ellipsis)),
                ...
                item.ratingCount! > 0 ? Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                  ...
                  Text(item.avgRating!.toStringAsFixed(1), style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                  const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                  Text("(${item.ratingCount})", style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                ]) : const SizedBox(),
                ...
                (Get.find<SplashController>().configModel!.moduleConfig!.module!.unit! && item.unitType != null) ? Text(
                  '(${ item.unitType ?? ''})',
                  style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).hintColor),
                ) : const SizedBox(),
                ...
                Text(
                  ...
                  textDirection: TextDirection.ltr, style: ralewayMedium,
                ),
