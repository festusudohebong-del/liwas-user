                ...
                Row(children: [
                  ...
                  Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    ...
                    Padding(padding: const EdgeInsets.only(top:18),
                      child: Text(provider?.name ?? '', style: ralewayBold.copyWith(fontSize: 13, color: Colors.grey.shade700)),
                    ),

                    Padding(padding: const EdgeInsets.symmetric(vertical: 7),
                      child: Text(provider?.address ?? '', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Colors.grey.shade700)),
                    )
                  ])
                ]),
