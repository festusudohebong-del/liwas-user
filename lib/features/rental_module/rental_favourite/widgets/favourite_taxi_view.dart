...
import 'package:liwas_user/features/rental_module/rental_favourite/widgets/favourite_vendor_card.dart';
import 'package:liwas_user/features/rental_module/rental_favourite/widgets/vehicle_shimmer.dart';
...
class _FavouriteTaxiViewState extends State<FavouriteTaxiView> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      ) : NoDataScreen(text: widget.noDataText ?? 'No vehicle available'.tr,)
          : GridView.builder(
        key: UniqueKey(),
        gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
