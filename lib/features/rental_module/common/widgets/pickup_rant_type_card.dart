...
import 'package:liwas_user/features/rental_module/rental_cart_screen/widgets/trip_type_bottom_sheet_widget.dart';
      ...
      child: Row(children: [
        ...
        Expanded(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text('Rant type'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
