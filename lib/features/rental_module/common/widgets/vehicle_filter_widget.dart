...
import 'package:liwas_user/features/rental_module/common/models/taxi_brand_model.dart';
import 'package:liwas_user/features/rental_module/helper/string_limit_helper.dart';
                  ...
                  builder: (taxiHomeController) {
                    return Column(mainAxisSize: MainAxisSize.min, children: [
                      ...
                      Padding(padding: const EdgeInsets.only(bottom: 10, top: 20),
                        child: Text('Filter by'.tr, style: ralewayMedium.copyWith(fontSize: 16.0, color: Theme.of(context).primaryColor)),
                      ),

                      Padding(padding: const EdgeInsets.symmetric(horizontal: 20),
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [

                          Text('Price range'.tr, style: ralewayBold.copyWith(fontSize: 14),),
                            ...
                            child: Row( mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
                              ...
                              RichText(text: TextSpan(children: <TextSpan>[
                                TextSpan(text: taxiHomeController.minPrice > 100000 ? PriceConverter.convertPrice(0, formatedStringPrice: NumberFormat.compact().format(taxiHomeController.minPrice)) : PriceConverter.convertPrice(taxiHomeController.minPrice),
                                    style: ralewayRegular.copyWith(color: Colors.black, fontSize: 14)),
                                TextSpan(text: '/${widget.tripType == 'hourly' ? 'hr'.tr : 'Km'.tr}', style: ralewayRegular.copyWith(color: Colors.grey.shade600, fontSize: 14))])
                              ),
                          ...
                          taxiHomeController.taxiBrandModel != null && taxiHomeController.taxiBrandModel!.brands != null ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Text('Brands'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeDefault),),
                            const SizedBox(height: Dimensions.paddingSizeSmall),
                        ...
                        !fromVendor && taxiHomeController.vehicleCategoryModel != null && taxiHomeController.vehicleCategoryModel!.vehicles!.isNotEmpty ? Column(
                            ...
                            Padding(
                              ...
                              child: Text('Vehicle type'.tr, style: ralewayBold.copyWith(fontSize: 14)),
                            ),
                                    ...
                                    child: CustomInkWell(
                                      ...
                                      child: Stack(children: [
                                        ...
                                        Container(
                                          ...
                                          child: Text(
                                            name,
                                            style: ralewayRegular.copyWith(fontSize: 12, fontWeight: selected ? FontWeight.bold : FontWeight.normal),
                                          ),
                                        ),
                          ...
                          Padding(
                            padding: const EdgeInsets.symmetric(vertical: 10),
                            child: Text('Seats'.tr, style: ralewayBold.copyWith(fontSize: 14)),
                          ),
                                  ...
                                  child: CustomInkWell(
                                    ...
                                    child: Stack(children: [
                                      ...
                                      Container(
                                        ...
                                        padding: const EdgeInsets.symmetric(horizontal: 15, vertical: 5),
                                        child: Text('${AppConstants.seats[index]} ${'Seats'.tr}', style: ralewayRegular.copyWith(fontSize: 12, fontWeight: selected ? FontWeight.bold : FontWeight.normal)),
                                      ),
                          ...
                          Padding(
                            padding: const EdgeInsets.symmetric(vertical: 10),
                            child: Text('Colling'.tr, style: ralewayBold.copyWith(fontSize: 14)),
                          ),
                            ...
                            Stack(children: [
                              ...
                              Container(
                                ...
                                child: CustomInkWell(
                                  ...
                                  padding: const EdgeInsets.symmetric(horizontal: 15, vertical: 5),
                                  child: Text('Air conditioned'.tr,
                                    style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, fontWeight: taxiHomeController.airCondition ? FontWeight.bold : FontWeight.normal),
                                  ),
                                ),
                              ),
                            ...
                            Stack(children: [
                              ...
                              Container(
                                ...
                                child: CustomInkWell(
                                  ...
                                  padding: const EdgeInsets.symmetric(horizontal: 15, vertical: 5),
                                  child: Text('No air conditioned'.tr,
                                    style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, fontWeight: taxiHomeController.nonAirCondition ? FontWeight.bold : FontWeight.normal),
                                  ),
                                ),
                              ),
          ...
          Container(
            ...
            child: SafeArea(
              child: Row(children: [
                ...
                Expanded(
                  child: CustomButton(
                    buttonText: 'Clear filter'.tr, height: 40,
                ...
                Expanded(
                  child: CustomButton(
                    buttonText: 'Apply filter'.tr, height: 40,
                    onPressed: () {
                      if(fromVendor) {
