        ...
        Expanded(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(
              ...
              DateConverter.isSameDate(taxiLocationController.finalTripDateTime!) || taxiLocationController.pickCurrentTime ? 'Pickup now'.tr : 'Custom'.tr
                  : 'Pick time'.tr,
            ...
            Text(
              userData != null ? DateConverter.dateTimeStringToDateTime(userData!.pickupTime!)
                  : taxiLocationController.finalTripDateTime != null
                  ? DateConverter.taxiDateTimeToString(taxiLocationController.finalTripDateTime!) : 'Not set yet'.tr,
