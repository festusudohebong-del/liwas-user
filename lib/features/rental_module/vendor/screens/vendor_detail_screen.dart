...
import 'package:liwas_user/features/rental_module/vendor/screens/review_details_screen.dart';
import 'package:liwas_user/features/rental_module/vendor/widgets/search_and_filter_widget.dart';
import 'package:liwas_user/features/rental_module/vendor/widgets/taxi_rating_bar.dart';
import 'package:liwas_user/features/rental_module/vendor/widgets/vendor_vehicle_card.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: Text('Provider details'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
        centerTitle: true,
      ...
      body: GetBuilder <TaxiVendorController>(builder: (vendorController){
        ...
        return CustomScrollView(slivers: [
              ...
              child: Column(children: [
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    ...
                    Expanded(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, spacing: 2, children: [
                        ...
                        Text(vendor.name ?? '', maxLines: 1, style: ralewayBold, overflow: TextOverflow.ellipsis),
                        Text(vendor.address ?? '', maxLines: 1, overflow: TextOverflow.ellipsis, style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                        Text('${'Approx pickup time'.tr}: ${vendor.deliveryTime??''}', maxLines: 1, overflow: TextOverflow.ellipsis, style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall)),
                      ]),
                    ),
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                      Row(children: [
                        ...
                        Text('${vendor.avgRating}', style: ralewayBold.copyWith(fontSize: 35, color: Theme.of(context).primaryColor)),
                        const SizedBox(width: 5),

                        RichText(text: TextSpan(children: <TextSpan>[

                          TextSpan(text: '${'Based on'.tr}\n', style: ralewayRegular.copyWith(fontSize: 14, color: Colors.grey.shade600)),

                          TextSpan(text: '${vendor.ratingCount} ', style: ralewayMedium.copyWith(fontSize: 14, color: Colors.grey.shade700)),

                          TextSpan(text: 'Ratings'.tr, style: ralewayRegular.copyWith(fontSize: 14, color: Colors.grey.shade600))
                        ])),
                      ]),
                    ...
                    CustomInkWell(
                      ...
                      child: Container(
                        ...
                        child: Text('View'.tr, style: ralewayMedium.copyWith(fontSize: 14)),
                      ),
                    )
                  ])
                ),
                ...
                vendor.announcement == 1 ? Container(
                  ...
                  child: Row(children: [
                    ...
                    Expanded(child: Text(vendor.announcementMessage ?? '', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall), softWrap: true)),
                ...
                vendor.discount != null ? Container(
                  ...
                  child: Text('${vendor.discount!.discountType == 'percent' ? '${vendor.discount!.discount}% '
                      ...
                      '${'Discount will be applicable when booking amount is more then'.tr} ${PriceConverter.convertPrice(vendor.discount!.minPurchase)},'
                      ' ${'Max'.tr} ${PriceConverter.convertPrice(vendor.discount!.maxDiscount)} ${'Discount is applicable'.tr}.',
                ...
                searchName.isNotEmpty ? Container(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                    ...
                    RichText(text: TextSpan(children: <TextSpan>[
                      ...
                      TextSpan(text: '${vendorController.taxiVendorVehicleList?.totalSize??0} ', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge!.color)),

                      TextSpan(text: 'Result found for'.tr, style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge!.color)),

                      TextSpan(text: ' $searchName', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge!.color))
          ...
          SliverToBoxAdapter(
            ...
            ) : NoDataScreen(text: 'No vehicle available'.tr) : const Center(child: Padding(
