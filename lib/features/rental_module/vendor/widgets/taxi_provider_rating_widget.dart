...
import 'package:liwas_user/features/review/widgets/rating_progress_widget.dart';
    ...
    return Row(children: [
      Expanded(
        ...
        child: Column(children: [
          Text('Overall rating'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
          ...
          Padding(
            ...
            child: Text(
              ...
              style: ralewayBold.copyWith(fontSize: 30, color: Theme.of(context).primaryColor),
            ),
          ),
          ...
          RichText(text: TextSpan(children: <TextSpan>[
            TextSpan(
                text: '${ratingCount ?? 0} ',
                style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Colors.grey.shade900)
            ),
            TextSpan(
                text: 'ratings'.tr,
                style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Colors.grey.shade700)
            )
          ])),
        ]),
      ),
