      ...
      child: Row(children: [
        ...
        Expanded(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text('${cart.vehicle?.name}', style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeDefault), maxLines: 1, overflow: TextOverflow.ellipsis,),
            const SizedBox(height: Dimensions.paddingSizeExtraSmall),

            Text('${cart.provider?.name}', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Colors.grey.shade700)),
            const SizedBox(height: Dimensions.paddingSizeExtraSmall),

            Row(children: [
              Text('${'quantity'.tr}: ', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeDefault)),
              Text('${cart.quantity}', style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
            ]),
          ]),
        ),
      ]),
