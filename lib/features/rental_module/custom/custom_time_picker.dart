  ...
  Widget build(BuildContext context) {
    return Padding(padding: const EdgeInsets.all(Dimensions.paddingSizeDefault ),
      child: TimePickerSpinner(
        ...
        is24HourMode: false,
        normalTextStyle: ralewayRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color!.withValues(alpha: 0.5), fontSize: Dimensions.fontSizeSmall),
        highlightedTextStyle: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge*1, color: Theme.of(context).textTheme.bodyLarge!.color),
