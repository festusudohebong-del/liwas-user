...
import 'package:liwas_user/features/rental_module/select_vehicle_screen/search_vehicle_screen.dart';
...
import 'package:liwas_user/features/rental_module/common/widgets/vehicle_filter_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text('Select vehicle'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
        centerTitle: true,
                  ...
                  child: Container(
                    ...
                    child: Column(
                      children: [
                          ...
                          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            ...
                            Expanded(
                              child: RichText(maxLines: 1, overflow: TextOverflow.ellipsis, text: TextSpan(children: <TextSpan>[
                                ...
                                TextSpan(text: '${taxiHomeController.selectedCarsModel?.totalSize??0} ', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Colors.black)),

                                TextSpan(text: 'Result found for'.tr, style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Colors.grey)),

                                TextSpan(text: ' $searchName', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Colors.black))
                        ...
                        Row(children: [
                          Expanded(child: Text('Vehicle list'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeDefault))),
            ...
            GetBuilder<TaxiCartController>(
              builder: (taxiCartController) {
                return taxiCartController.cartList.isNotEmpty ? Container(
                  ...
                  child: SafeArea(
                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      Text('${taxiCartController.cartList.length} ${'Vehicle selected'.tr}', style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).disabledColor)),

                      CustomButton(
                        buttonText: 'View cart'.tr,
                        width: 100, height: 40,
