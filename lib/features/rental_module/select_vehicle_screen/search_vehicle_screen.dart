...
import 'package:liwas_user/common/widgets/custom_debounce_widget.dart';
...
import 'package:liwas_user/features/rental_module/select_vehicle_screen/widgets/search_text_field.dart';
        ...
        child: Column(children: [
          ...
          Padding(
            ...
            child: SearchTextField(
              ...
              hintText: "Type here to search vehicle".tr,
              onIconPressed: () {
  ...
  Widget searchSuggestionsView() {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        Text('Search suggestions'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
        ...
        _vehicles.isNotEmpty ? ListView.builder(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Expanded(
                  child: Row(children: [
                    ...
                    Flexible(child: Text(_vehicles[index], maxLines: 1, overflow: TextOverflow.ellipsis, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall)))
                  ]),
                ),
          ...
          child: Text('No suggestions found'.tr),
        )),
      ]),
    );
  }
          ...
          return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            taxiHomeController.searchHistoryList.isNotEmpty ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Text('Last search'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeDefault)),

                TextButton(
                  onPressed: () {
                    taxiHomeController.clearSearchHistory();
                  },
                  child: Text('Clear all'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Colors.redAccent)),
                )
              ]),
            ...
            SizedBox(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text('Popular search'.tr, style: ralewayBold.copyWith(fontSize: 14)),
                  ...
                  children: List.generate(taxiHomeController.popularCarSuggestionModelList!.length, (index) => CustomInkWell(
                    ...
                    child: Container(
                      ...
                      child: Text(
                        ...
                        style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Get.find<ThemeController>().darkTheme ? Colors.white70 : const Color(0xFF313F38)),
                      ),
                    ),
                  )),
                ),
