                      ...
                      children: [
                        ...
                        Expanded(
                          child: Padding(
                            ...
                            child: Text(
                              '${widget.vehicleModel.vehicleIdentitiesCount!} ${'Vehicles available'.tr}',
                ...
                child: Padding(
                  ...
                  child: SizedBox(
                    ...
                    child: Text(
                      ...
                      style: ralewayRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color!.withValues(alpha: 0.5), fontSize: Dimensions.fontSizeExtraSmall),
                      textAlign: TextAlign.left, maxLines: 1, overflow: TextOverflow.ellipsis,
                    ),
            ...
            Align(
              ...
              child: SingleChildScrollView(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.start, mainAxisSize: MainAxisSize.min, children: [
                  ...
                  FeatureItem(image: Images.taxiACIcon, text: widget.vehicleModel.airCondition! ? 'Ac'.tr : 'Non ac'.tr, iconColor: Colors.grey),
