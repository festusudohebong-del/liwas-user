        ...
        const SizedBox(width: Dimensions.paddingSizeSmall),
          ...
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text('${myAddressModelNew.title}', style: ralewayMedium.copyWith(fontSize: 12, color: Colors.black87)),
              const SizedBox(height: 3),

              Text('${myAddressModelNew.address}',
                style: ralewayRegular.copyWith(fontSize: 10, color: Colors.grey.shade800),
                maxLines: 1,
