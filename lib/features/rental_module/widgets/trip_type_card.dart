            ...
            child: Column(children: [
              ...
              Container(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  Text(tripType.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
              ...
              Container(
                ...
                child: haveVehicle! ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  RichText(text: TextSpan(children: <TextSpan>[
                    TextSpan(text: '${'Start from'.tr} ', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge!.color)),

                    discountType == 'amount' ? const TextSpan() :
                    TextSpan(text: discountAmount == amount ? '' : amount, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor, decoration: TextDecoration.lineThrough)),
                  ])),

                  RichText(text: TextSpan(children: <TextSpan>[
                    TextSpan(text: ' ${discountType == 'amount' ? amount : discountAmount}', style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).textTheme.bodyLarge!.color)),

                    TextSpan(text: ' /${fareType.tr}', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge!.color)),
                  ])),
                ]) : RichText(text: TextSpan(children: <TextSpan>[
                  TextSpan(text: '${'Start from'.tr} \n', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge!.color)),

                  TextSpan(text: PriceConverter.convertPrice(dailyMinPrice ?? distanceMinPrice ?? hourMinPrice), style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).textTheme.bodyLarge!.color)),
