      ...
      child: Row(children: [
        ...
        Expanded(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text('Rent Type', style: ralewayMedium.copyWith(fontSize: 12, color: Colors.black,)),
            const SizedBox(height: 5),

            Text('Hourly (Estimated 5hr)', style: ralewayRegular.copyWith(fontSize: 12, color: Colors.grey.shade800),),
