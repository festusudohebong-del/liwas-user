      ...
      child: InkWell(
        ...
        child: Row(children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(recentAddressModel.place ?? '', style: ralewayRegular.copyWith(fontSize: 12)),
            Text(recentAddressModel.address ?? '', style: ralewayRegular.copyWith(fontSize: 12, color: Colors.grey))
