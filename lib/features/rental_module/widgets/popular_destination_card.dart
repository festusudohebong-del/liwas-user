      ...
      child: InkWell(
        ...
        child: Row(children: [
          ...
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Text(recentAddressModel.place ?? '', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
            Text(recentAddressModel.address ?? '', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Colors.grey))
