  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text('Add address'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
                ...
                Expanded(
                  ...
                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Padding(
                      ...
                      child: Text('Add address'.tr, style: ralewayBold.copyWith(fontSize: 12)),
                    ),

                    Text('Type or select from map'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall)),
                  ]),
                ),
