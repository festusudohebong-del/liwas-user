...
import 'package:liwas_user/features/rental_module/rental_location_screen/widgets/taxi_location_result_bottom_sheet.dart';
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        showTitle ? Padding(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Text('Trip info'.tr, style: ralewayBold),
              ...
              Expanded(
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  ...
                  if(fromAddress.addressType != null && fromAddress.addressType!.isNotEmpty)
                    Text(fromAddress.addressType?.tr??'Other'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
        ...
        Row(children: [
          ...
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Text(toAddress.addressType?.tr??'Other'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
