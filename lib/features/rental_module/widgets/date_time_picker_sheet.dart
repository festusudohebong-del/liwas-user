...
import 'package:liwas_user/features/rental_module/custom/custom_time_picker.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        //heading
        Text('Set date and time'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge),),
        ...
        Container(
          ...
          child: SfDateRangePicker(
            ...
            headerStyle: DateRangePickerHeaderStyle(
              ...
              textStyle: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge),
            ),
        ...
        Container(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceEvenly, children: [
            ...
            Text('Time'.tr, style: ralewayMedium),
              ...
              builder: (taxiCartController) {
                return !taxiCartController.isLoading ? Row(children: [
                  TextButton(
                    ...
                    child: Text(
                      'Pickup now'.tr,
                      style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).textTheme.bodyMedium!.color),
                    ),
                  ),
                  const Spacer(),
                  ...
                  TextButton(
                    onPressed: () => Get.back(),
                    child: Text('Cancel'.tr, style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).textTheme.bodyLarge!.color),),
                  ),
                  ...
                  CustomButton(
                    ...
                    onPressed: canUpdate ? (){
                      ...
                      if(DateConverter.isAfterCurrentDateTime(date)) {
                        ...
                        showCustomSnackBar('You cannot select before current time'.tr, getXSnackBar: true);
                      }
                      date = date;
