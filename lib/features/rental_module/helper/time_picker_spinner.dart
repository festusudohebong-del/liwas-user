  ...
  Widget build(BuildContext context) {
    List<Widget> contents = [
      ...
      Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
        child: Text(':',style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge),),
      ),
      Container(
        decoration: BoxDecoration(
          color: Theme.of(context).disabledColor.withValues(alpha: 0.2),
        ...
        child: Row(mainAxisSize: MainAxisSize.min, children: [
          ...
          InkWell(
            ...
            child: Container(
              ...
              padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
              child: Text(
                'am'.tr, style: ralewayMedium.copyWith(color: isAmSelect ? Colors.white : Theme.of(context).textTheme.bodyMedium!.color),
              ),
            ),
          ),
          ...
          InkWell(
            ...
            child: Container(
              ...
              padding: const EdgeInsets.all(Dimensions.paddingSizeSmall),
              child: Text(
                'pm'.tr, style: ralewayMedium.copyWith(color: isPmSelect ? Colors.white : Theme.of(context).textTheme.bodyMedium!.color),
              ),
            ),
          ),
          // TextButton(
          //   onPressed: () {},
          //   child: Text('AM', style: ralewayRegular.copyWith (fontSize:14, color: Colors.grey.shade600),),
          // ),
          //
          // ElevatedButton(
          //   onPressed: () {},
          ...
          //   ),
          //   child: Text('PM', style: ralewayBold.copyWith(color: Colors.white, fontSize: 14)),
          // ),
