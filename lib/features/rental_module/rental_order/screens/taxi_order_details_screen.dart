...
import 'package:liwas_user/features/rental_module/rental_order/widgets/additional_note.dart';
import 'package:liwas_user/features/rental_module/rental_order/widgets/deliveryman_view.dart';
import 'package:liwas_user/features/rental_module/rental_order/widgets/provider_view.dart';
import 'package:liwas_user/features/rental_module/rental_order/widgets/selected_vehicles_view.dart';
import 'package:liwas_user/features/rental_module/rental_order/widgets/trip_calculation_view.dart';
import 'package:liwas_user/features/rental_module/rental_order/widgets/trip_details_widget.dart';
import 'package:liwas_user/features/rental_module/rental_order/widgets/trip_status_view.dart';
import 'package:liwas_user/features/rental_module/widgets/booking_cancel_bottomsheet.dart';
import 'package:liwas_user/features/rental_module/rental_order/widgets/taxi_payment_bottom_sheet.dart';
import 'package:liwas_user/features/rental_module/widgets/confirm_booking_request_bottom_sheet.dart';
import 'package:liwas_user/features/rental_module/widgets/review_bottom_sheet.dart';
          ...
          child: Scaffold(
            appBar: AppBar(
              ...
              title: Column(children: [
                Text('${'trip'.tr} # ${widget.tripId}', style: ralewayMedium),
                Text(
                  tripDetailsModel.tripStatus == TripStatusEnum.completed.name
                    ? tripDetailsModel.paymentStatus != 'paid' ? 'Trip cost'.tr : tripDetailsModel.tripStatus!.tr
                    : tripDetailsModel.tripStatus!.tr, style: ralewayMedium.copyWith(color: Theme.of(context).disabledColor),
                ),
              ]),
              centerTitle: true,
            ),
                      ...
                      child: Column(spacing: Dimensions.paddingSizeSmall, children: [
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          ...
                          RichText(text: TextSpan(children: <TextSpan>[
                            TextSpan(text: '${'Estimated'.tr} ', style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).textTheme.bodyLarge!.color)),
                            TextSpan(text: taxInclude ? 'Vat tax inc'.tr : '', style: ralewayMedium.copyWith(fontSize: 10, color: Theme.of(context).disabledColor))
                          ])),

                          Text(PriceConverter.convertPrice(total, forTaxi: true), style: ralewayBold.copyWith(fontSize: 18)),
                        ]),
                        ...
                        ElevatedButton(
                          ...
                          child: Text('Cancel booking'.tr, style: ralewayBold.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color)),
                        ),
                      ]),
                    ) : const SizedBox(),
              ...
              child: ElevatedButton(
                onPressed: () {
                  if(tripDetailsModel.vehicleIdentity!.isNotEmpty) {
                    ...
                    showCustomSnackBar('Not found any assigned vehicle'.tr);
                  }
                ...
                child: Text('Give review'.tr, style: ralewayBold.copyWith(color: Theme.of(context).primaryColor, fontSize: 16)),
              ),
            ),
          ]),
