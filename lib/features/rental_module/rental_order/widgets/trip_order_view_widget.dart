...
import 'package:liwas_user/features/rental_module/rental_order/widgets/taxi_order_shimmer_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<TaxiOrderController>(builder: (taxiOrderController) {
                      ...
                      Row(children: [
                        ...
                        Expanded(
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            Row(children: [
                              ...
                              Text('#${tripModel.trips![index].id}', style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
                            ]),
                        ...
                        Column(crossAxisAlignment: CrossAxisAlignment.end, children: [
                          !ResponsiveHelper.isDesktop(context) ? Container(
                            ...
                            child: Text(tripModel.trips![index].tripStatus!.tr, style: ralewayMedium.copyWith(
                          ...
                          /*isRunning ? InkWell(
                            ...
                            child: Container(
                              ...
                              child: Row(children: [
                                ...
                                const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                Text('Track trip'.tr, style: ralewayMedium.copyWith(
        ...
        ) : NoDataScreen(text: 'No order found'.tr, showFooter: true) : TaxiOrderShimmerWidget(taxiOrderController: taxiOrderController);
      }),
    );
  }
}
