  ...
  Widget build(BuildContext context) {
    ...
    return dm.isNotEmpty ? Container(
      ...
      child: Column(
        ...
        children: [
          Text('Assigned driver'.tr, style: ralewayBold.copyWith(fontSize: 14)),
      ...
      child: Row(spacing: Dimensions.paddingSizeSmall, children: [
        ...
        Expanded(
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, spacing: Dimensions.paddingSizeExtraSmall, children: [
            ...
            Text('${data.firstName} ${data.lastName}', style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeDefault), maxLines: 1, overflow: TextOverflow.ellipsis,),

            Text(data.phone??'', style: ralewayMedium.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall)),
        ...
        CustomInkWell(
          onTap: () async {
            if(await canLaunchUrlString('tel:${data.phone}')) {
              ...
              showCustomSnackBar('${'Can not launch'.tr} ${data.phone}');
            }
          },
