...
class _SelectedVehiclesViewState extends State<SelectedVehiclesView> {
  ...
  Widget showMultipleView(BuildContext context, List<TripDetails> tripDetailsList) {
    return Row(children: [
                ...
                if(tripDetailsList.length > 3)
                  Positioned(
                    ...
                    child: Container(
                      ...
                      child: Center(child: Text('${tripDetailsList.length - 3}+', style: ralewayBold.copyWith(color: Colors.white, fontSize: Dimensions.fontSizeExtraLarge),)),
                    ),
                  )
              ],
            ),
      ...
      Text(
        '${'Total'.tr} ${tripDetailsList.length} ${'Vehicle selected'.tr}',
        style: ralewayMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color!.withValues(alpha: 0.8)),
      ),
    ]);
  }
}
          ...
          Expanded(
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Padding(
                ...
                child: Text('${widget.tripDetails.vehicleDetails!.name}', style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeDefault), maxLines: 1, overflow: TextOverflow.ellipsis,),
              ),

              RichText(text: TextSpan(children: <TextSpan>[

                TextSpan(text: '${'Quantity'.tr}: ', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).disabledColor)),

                TextSpan(text: '${widget.tripDetails.quantity}', style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).disabledColor))
              ]))
                ...
                child: Wrap(
                    ...
                    children: widget.tripDetails.licensePlateNumber!.map((number) {
                      return Text(
                        ...
                        style: ralewayMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color!.withValues(alpha: 0.5)),
                      );
                    }).toList()),
              ),
            ),
