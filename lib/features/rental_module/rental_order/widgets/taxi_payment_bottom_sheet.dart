      ...
      child: GetBuilder<TaxiOrderController>(
        builder: (taxiOrderController) {
          return Column(children: [
            ...
            //title
            Text('Choose payment method'.tr, style: ralewayBold),
                  ...
                  Padding(
                    ...
                    child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: [
                      ...
                      Padding(
                        ...
                        child: Text('Total trip cost'.tr, style: ralewayMedium.copyWith(fontSize: 14, color: Colors.grey.shade700)),
                      ),
                      ...
                      Container(
                        ...
                        child: CustomInkWell(
                          ...
                          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            ...
                            Text('Cash payment'.tr, style: ralewayBold.copyWith(fontSize: 14)),
                      ...
                      Container(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Padding(
                            padding: const EdgeInsets.all(Dimensions.paddingSizeDefault),
                            child: Text('Online payment'.tr,  style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
                          ),
        ...
        child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(children: [
              ...
              Text(
                isWalletSelected ? ' (${'Applied wallet'.tr})' : '',
      ...
      if(isWalletSelected && !taxiOrderController.isPartialPay)
        Container(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            ...
            Text('Wallet payment'.tr, style: ralewayBold.copyWith(fontSize: 14)),
      ...
      if(isWalletSelected && taxiOrderController.isPartialPay)
        Column(children: [
          Container(
            ...
            child: Column(children: [
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Text('Wallet payment'.tr, style: ralewayMedium.copyWith(fontSize: 14, color: Colors.grey.shade700)),
          ...
          if(taxiOrderController.paymentMethodIndex == 0)
            Text('* ${'Please select how to pay remain billing amount'.tr}', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: const Color(0xFFE74B4B))),
