    ...
    return Container(
      ...
      child: Column(children: [
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Text('Total'.tr, style: ralewayMedium),
          Text(PriceConverter.convertPrice(total, forTaxi: true), style: ralewayMedium, textDirection: TextDirection.ltr),
        ]),
        const SizedBox(height: Dimensions.paddingSizeSmall),

        if(walletPay != null && walletPay! > 0)
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Text('Wallet payment'.tr, style: ralewayRegular),
          Text('- ${PriceConverter.convertPrice(0)}', style: ralewayRegular, textDirection: TextDirection.ltr),
        ]),
        SizedBox(height: (walletPay != null && walletPay! > 0) ?Dimensions.paddingSizeSmall : 0),

        if(duePay != null && duePay! > 0)
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Text('Due payment'.tr, style: ralewayRegular),
          Text('- ${PriceConverter.convertPrice(0)}', style: ralewayRegular, textDirection: TextDirection.ltr),
        ]),
