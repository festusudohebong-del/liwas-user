...
import 'package:liwas_user/features/rental_module/rental_location_screen/widgets/animated_map_icon_extended.dart';
import 'package:liwas_user/features/rental_module/rental_location_screen/widgets/animated_map_icon_minimized.dart';
import 'package:liwas_user/features/rental_module/rental_location_screen/widgets/rider_address_input_field.dart';
    ...
    return GetBuilder<TaxiLocationController>(
        ...
        return Scaffold(
          appBar: CustomAppBar(title: widget.fromSuggestionMap! && !_isPicked
              ? taxiLocationController.isFormSelected ? 'Set pickup location'.tr : 'Set destination location'.tr
              : 'Location'.tr),
          body: Stack(children: [
            GoogleMap(
            ...
            Positioned(
              ...
              child: Container(
                ...
                child: SafeArea(
                  child: CustomButton(
                    buttonText: !taxiLocationController.inZone ? 'Service not available in this area'.tr : widget.fromSuggestionMap! && !_isPicked ? 'Pick address'.tr : 'Confirm'.tr,
          ...
          child: Padding(
            ...
            child: Text(
              taxiLocationController.isFormSelected
                  ? taxiLocationController.formTextEditingController.text.isEmpty ? 'Enter pickup'.tr : taxiLocationController.formTextEditingController.text
                  : taxiLocationController.toTextEditingController.text.isEmpty ? 'Enter destination'.tr : taxiLocationController.toTextEditingController.text,
              style: ralewayRegular.copyWith(color: taxiLocationController.isFormSelected
