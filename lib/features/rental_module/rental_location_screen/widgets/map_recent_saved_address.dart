          ...
          return SingleChildScrollView(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, spacing: Dimensions.paddingSizeSmall, children: [
              ...
              taxiLocationController.historyAddress != null && taxiLocationController.historyAddress!.isNotEmpty ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text('Recent address'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
                    ...
                    return CustomInkWell(
                      ...
                      child: Padding(
                        ...
                        child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Text(taxiLocationController.historyAddress![index].addressType?.tr??'Other'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
                          Text(
                            taxiLocationController.historyAddress![index].address??'', maxLines: 2, overflow: TextOverflow.ellipsis,
                            style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyLarge!.color!.withValues(alpha: 0.5)),
                          ),
              ...
              GetBuilder<AddressController>(
                builder: (addressController) {
                  return addressController.addressList != null && addressController.addressList!.isNotEmpty ? Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                    Text('Saved address'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
                      ...
                      itemBuilder: (context, index) {
                        return CustomInkWell(
                          ...
                          child: Row(children: [
                            ...
                            Text('${addressController.addressList![index].addressType?.tr}'' - ', style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
              ...
              CustomInkWell(
                ...
                child: Row(children: [
                  ...
                  Text('Select from map'.tr, style: ralewayRegular),
                ]),
              ),
