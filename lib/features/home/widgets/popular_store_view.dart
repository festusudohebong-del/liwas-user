      ...
      return (storeList != null && storeList.isEmpty) ? const SizedBox() : Column(
        children: [
          Padding(
            ...
            child: TitleWidget(
              title: isFeatured ? 'Recommended for you'.tr : isPopular ? Get.find<SplashController>().configModel!.moduleConfig!.module!.showRestaurantText!
                  ? 'Popular restaurants'.tr : 'Popular stores'.tr : '${'New on'.tr} ${AppConstants.appName}',
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.start, children: [
                              ...
                              storeList[index].ratingCount != null && storeList[index].ratingCount! > 0 ? RichText(
                                text: TextSpan(children: [
                                  TextSpan(text: '★ ', style: ralewayBold.copyWith(color: Colors.orange)),
                                  TextSpan(
                                    text: '${storeList[index].avgRating}',
                                    style: ralewayBold.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color, fontSize: Dimensions.fontSizeSmall),
                                  ),
                                  const TextSpan(text: ' '),
                                  TextSpan(
