import 'package:liwas_user/common/widgets/corner_banner/banner.dart';
import 'package:liwas_user/common/widgets/corner_banner/corner_discount_tag.dart';
      ...
      return (itemList != null && itemList.isEmpty) ? const SizedBox() : Column(
        children: [
          Padding(
            ...
            child: TitleWidget(
              title: isPopular ? 'Popular items nearby'.tr : 'Best reviewed item'.tr,
