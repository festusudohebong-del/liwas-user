...
import 'package:liwas_user/features/home/widgets/components/item_that_you_love_card_widget.dart';
      ...
      return recommendItems != null ? recommendItems.isNotEmpty ? Stack(children: [
          Column(children: [
            ...
            Padding(
              ...
              child: Text('Item that you love'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
            ),
                                          ...
                                          children: [
                                            Container(
                                              ...
                                              child: Column(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                                Text(recommendItems[index].name!, style: ralewayBold, maxLines: 1, overflow: TextOverflow.ellipsis),

                                                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                                  Icon(Icons.star, size: 15, color: Theme.of(context).primaryColor),
                                                  const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                                  Text(recommendItems[index].avgRating!.toStringAsFixed(1), style: ralewayRegular),
                                                  const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                                  Text("(${recommendItems[index].ratingCount})", style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                                                ]),
                                  ...
                                  Container(
                                    ...
                                    child: Column(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                      ...
                                      Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                        Icon(Icons.star, size: 15, color: Theme.of(context).primaryColor),
                                        const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                        Text('0.0', style: ralewayRegular),
                                        const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                        Text("(0)", style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                                      ]),
