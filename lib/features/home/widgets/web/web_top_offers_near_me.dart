...
import 'package:liwas_user/common/widgets/card_design/store_card_with_distance.dart';
import 'package:liwas_user/common/widgets/custom_image.dart';
import 'package:liwas_user/common/widgets/hover/on_hover.dart';
import 'package:liwas_user/common/widgets/hover/text_hover.dart';
import 'package:liwas_user/common/widgets/rating_bar.dart';
import 'package:liwas_user/common/widgets/title_widget.dart';
import 'package:liwas_user/features/home/widgets/web/widgets/arrow_icon_button.dart';
        ...
        Container(
          ...
          child: Column(children: [
            ...
            Padding(
              ...
              child: TitleWidget(
                title: 'Top offers near me'.tr, image: Images.fireIcon,
                            ...
                            Expanded(
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                ...
                                isFood ? RatingBar(
                                  ...
                                  Text('${store.avgRating}', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall)),
                                  const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                                  Text('(${store.ratingCount})', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor)),
                                ]),
                                ...
                                Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                                  ...
                                  Text(isAvailable ? 'Open now'.tr : 'Closed now'.tr, style: ralewayRegular.copyWith(color: isAvailable ? const Color(0xffECA507) : Theme.of(context).colorScheme.error, fontSize: Dimensions.fontSizeExtraSmall)),
                                ]),
                            ...
                            child: Row(children: [
                              ...
                              Expanded(
                                child: Row(children: [
                                  ...
                                  Text(
                                    ...
                                    style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).primaryColor),
                                  ),
                                  const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                                  Text('From you'.tr, style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).primaryColor)),
                                ]),
                              ),
                              ...
                              Container(
                                ...
                                child: Text(
                                  ...
                                  style: ralewayMedium.copyWith(color: Theme.of(context).cardColor, fontSize: Dimensions.fontSizeExtraSmall),
                                  textAlign: TextAlign.center,
                                ),
                                // child: Text('New'.tr, style: ralewayMedium.copyWith(color: Theme.of(context).cardColor, fontSize: Dimensions.fontSizeSmall)),
                              ),
                            ]),
                          ),
                        ),
  ...
  Widget distanceWidget(double distance) {
    return Container(
      ...
      child: Row(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text(
          '${distance > 100 ? '100+' : distance.toStringAsFixed(2)} ${'Km'.tr}',
          style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor),
        ),
        const SizedBox(width: Dimensions.paddingSizeExtraSmall),

        Text('From you'.tr, style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor)),
