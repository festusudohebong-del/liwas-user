...
import 'package:liwas_user/features/home/widgets/web/widgets/medicine_item_card.dart';
      ...
      return products.isNotEmpty ? Column(children: [
        Padding(
          ...
          child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            Text('Basic medicine nearby'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                      ...
                      children: [
                        InkWell(
                          ...
                          child: Padding(
                            ...
                            child: Text('${categories[index].name}', style: ralewayMedium.copyWith(color: isSelected ? Theme.of(context).primaryColor : Theme.of(context).disabledColor)),
                          ),
                        ),
                      ],
                    );
