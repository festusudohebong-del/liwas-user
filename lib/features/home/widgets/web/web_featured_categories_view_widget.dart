            ...
            child: Container(
              ...
              child: Column(children: [
                Padding(
                  ...
                  child: Column(children: [
                    Text('Featured categories'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                          ...
                          return Column(children: [
                            InkWell(
                              ...
                              child: Padding(
                                ...
                                child: Text('${categoryList[index].name}', style: ralewayMedium.copyWith(color: isSelected ? Theme.of(context).primaryColor : Theme.of(context).disabledColor)),
                              ),
                            ),
