      ...
      return flashSaleController.flashSaleModel != null ? flashSaleController.flashSaleModel!.activeProducts != null ? Container(
        ...
        child: Column(children: [
            ...
            child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
              InkWell(
                ...
                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                  Text('Flash sale'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
          ...
          Padding(
            ...
            child: Text("${item!.name}", style: ralewayRegular, maxLines: 1, overflow: TextOverflow.ellipsis,),
          ),
          const SizedBox(height: Dimensions.paddingSizeExtraSmall),
          ...
          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
            Text('${'Available'.tr} : ', style: ralewayRegular.copyWith(color: Theme.of(context).disabledColor)),
            Text('$remaining ${'Item'.tr}', style: ralewayRegular.copyWith(color: Theme.of(context).primaryColor)),
          ]),
