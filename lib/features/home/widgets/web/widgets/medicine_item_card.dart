                ...
                Expanded(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      Text(item.name ?? '', style: ralewayBold,
                        maxLines: 1, overflow: TextOverflow.ellipsis,
                      ),
                        ...
                        Wrap(
                          children: List.generate(item.genericName!.length, (index) {
                            return Text(
                              ...
                              style: ralewayRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color?.withValues(alpha: 0.5), fontSize: Dimensions.fontSizeSmall),
                              maxLines: 1, overflow: TextOverflow.ellipsis,
                            );
                          }),
                        ),
                      ...
                      if(isShop)
                        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                          ...
                          Text(item.avgRating.toString(), style: ralewayRegular),
                          const SizedBox(width: Dimensions.paddingSizeExtraSmall),
