    ...
    return GetBuilder<StoreController>(builder: (storeController) {
      return Container(
        ...
        child: Row(children: [
          ...
          Text(storeTypeText, style: ralewayMedium.copyWith(color: storeController.filterType == storeType ? Theme.of(context).primaryColor : Theme.of(context).disabledColor)),
        ]),
      );
    }
    );
