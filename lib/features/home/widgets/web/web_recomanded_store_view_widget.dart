    ...
    return GetBuilder<StoreController>(builder: (storeController) {
      return storeController.recommendedStoreList != null ? Container(
        ...
        child: Column(children: [
          Text(isFood ? 'Recommended restaurants'.tr : 'Recommended stores'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
          ...
          Container(
            ...
            child: storeController.recommendedStoreList!.isNotEmpty ? GridView.builder(
              ...
              child: Text(isFood ? 'Currently no recommended restaurant available'.tr : 'Currently no recommended store available'.tr),
            )),
          ),
        ]),
