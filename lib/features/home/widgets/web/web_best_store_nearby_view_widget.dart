...
import 'package:liwas_user/common/widgets/card_design/store_card.dart';
                ...
                child: Row(children: [
                  ...
                  InkWell(
                    ...
                    child: Padding(
                      ...
                      child: Text(
                        'See all'.tr,
                        style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor, decoration: TextDecoration.underline),
                      ),
                    ),
                  ),
                  ...
                  children: [
                    ...
                    !isPharmacy ? RotatedBox(
                      ...
                      child: Padding(
                        ...
                        child: Text('Best store nearby'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                      ),
                    ) : const SizedBox(),
                                      ...
                                      child: Stack(children: [
                                        ...
                                        Container(
                                          ...
                                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                                ...
                                                Expanded(
                                                  ...
                                                  child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                                    ...
                                                    Row(children: [
                                                      ...
                                                      Text('Start from'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall)),
                                                      const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                                                      Text(PriceConverter.convertPrice(storeList[index].minimumOrder), style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeSmall)),
                                                    ...
                                                    Row(children: [
                                                      ...
                                                      Text(storeList[index].avgRating!.toStringAsFixed(1), style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                                                      const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                                                      Text("(${storeList[index].ratingCount.toString()})", style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                                                    ...
                                                    Container(
                                                      ...
                                                      child: Row(children: [
                                                        ...
                                                        Text('${distance > 10 ? '10+' : distance.toStringAsFixed(1)} ${'Km'.tr}', style: ralewayBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeExtraSmall)),
                                                        const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                                                        Text('From you'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeExtraSmall)),
                                                      ]),
                                                    ),
                                            ...
                                            Expanded(
                                              flex: 2,
                                              child: Text(storeList[index].name!, style: ralewayMedium, maxLines: 1, overflow: TextOverflow.ellipsis),
                                            ),
                                          ]),
                                        ),
