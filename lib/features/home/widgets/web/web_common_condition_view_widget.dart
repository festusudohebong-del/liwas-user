        ...
        child: Column(children: [
          Padding(
              ...
              child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                Text('Common condition'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                        ...
                        return InkWell(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              ...
                              style: ralewayMedium.copyWith(color: isSelected ? Theme.of(context).primaryColor : Theme.of(context).disabledColor),
                            ),
                          ),
                        );
                      },
