      ...
      return (storeList != null && storeList.isEmpty) ? const SizedBox() : Stack(children: [
          Column(children: [
            ...
            Padding(
              ...
              child: TitleWidget(
                title: '${'New on'.tr} ${AppConstants.appName}',
                                        ...
                                        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                          ...
                                          Expanded(
                                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                              ...
                                              SizedBox(
                                                width: 150,
                                                child: Text(storeList[index].name ?? '', style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall),
                                              ...
                                              Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                                                ...
                                                Text(storeController.isOpenNow(storeList[index]) ? 'Open now'.tr : 'Closed now'.tr, style: ralewayRegular.copyWith(color: storeController.isOpenNow(storeList[index]) ? const Color(0xffECA507) : Theme.of(context).colorScheme.error, fontSize: Dimensions.fontSizeSmall)),
                                              ]),
                                      ...
                                      child: Row(children: [
                                        ...
                                        Container(
                                          ...
                                          child: Row(children: [
                                            ...
                                            Text('From you'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).primaryColor)),
                                          ]),
                                        ),
                                      ]),
                                    ),
