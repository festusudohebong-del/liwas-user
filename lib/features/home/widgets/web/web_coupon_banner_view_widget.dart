                        ...
                        Column(
                          ...
                          children: [
                            Text(
                              ...
                              style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeOverLarge, color: Theme.of(context).textTheme.bodyLarge!.color!.withValues(alpha: 0.8)),
                            ),
                            ...
                            Row(
                              children: [
                                Text(
                                  'Min order of'.tr,
                                  style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).textTheme.bodyLarge!.color!.withValues(alpha: 0.8)),
                                ),
                    ...
                    child: InkWell(
                      onTap: () {
                        if(couponController.couponList![itemIndex].code != null){
                          ...
                          showCustomSnackBar('Coupon code copied'.tr, isError: false);
                        }
                      },
                      child: Container(
                        height: 35, width: 130,
                        ...
                        child: Row(mainAxisSize: MainAxisSize.min, children: [
                          ...
                          Text(couponController.couponList![itemIndex].code ?? '', style: ralewayMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeSmall)),
                        ]),
                      ),
                    ),
                  ),
