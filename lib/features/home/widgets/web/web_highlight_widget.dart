              ...
              Padding(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text('Highlights for you'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Get.isDarkMode ? Colors.white : Colors.black)),
                      const SizedBox(width: 5),

                      Text('See our most popular store and item'.tr, style: ralewayRegular.copyWith(color: Get.isDarkMode ? Colors.white70 : Theme.of(context).hintColor, fontSize: Dimensions.fontSizeSmall)),
                    ],
                  ),
