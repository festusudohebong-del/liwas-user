...
import 'package:liwas_user/common/widgets/custom_favourite_widget.dart';
              ...
              Padding(
                ...
                child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                  ...
                  Column(
                    ...
                    children: [
                      Text('Highlights for you'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Colors.black)),
                      const SizedBox(width: 5),

                      Text('See our most popular store and item'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall)),
                    ],
                  ),
                        ...
                        child: Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              advertisement.isRatingActive == 1 ? Text('${advertisement.averageRating?.toStringAsFixed(1)}', style: ralewayBold.copyWith(color: Theme.of(context).cardColor)) : const SizedBox(),
                              SizedBox(width: advertisement.isRatingActive == 1 ? 5 : 0),

                              advertisement.isReviewActive == 1 ? Text('(${advertisement.reviewsCommentsCount})', style: ralewayRegular.copyWith(color: Theme.of(context).cardColor)) : const SizedBox(),
                            ],
                          ),
                        ),
                      ) : const SizedBox(),
                    ...
                    Flexible(
                      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                          ...
                          Flexible(
                            child: Text(
                              advertisement.title ?? '', style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge, fontWeight: FontWeight.w600),
            ...
            child: Padding(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text(
                  ...
                  style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge, fontWeight: FontWeight.w600),
                  maxLines: 1, overflow: TextOverflow.ellipsis,
                ),
                const SizedBox(height: Dimensions.paddingSizeExtraSmall),
