...
import 'package:liwas_user/common/widgets/card_design/visit_again_card.dart';
...
import 'package:liwas_user/features/home/widgets/components/custom_triangle_shape.dart';
        ...
        child: Stack(clipBehavior: Clip.none, children: [
            ...
            Padding(
              ...
              child: Column(children: [
                ...
                Text(widget.fromFood! ? "Wanna try again".tr : "Visit again".tr, style: ralewayBold.copyWith(color: Theme.of(context).cardColor)),
                const SizedBox(height: Dimensions.paddingSizeSmall),

                Text(
                  'Get your recent purchase from the shop you recently ordered'.tr,
