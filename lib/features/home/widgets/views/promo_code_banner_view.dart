                ...
                child: Row(children: [
                  ...
                  Expanded(
                    ...
                    child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.center, children: [
                      Text(
                        '${couponController.couponList![itemIndex].title ?? ''} ${'Min order of'.tr} ${PriceConverter.convertPrice(couponController.couponList![itemIndex].minPurchase)}',
                          textAlign: TextAlign.center,
                          style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).textTheme.bodyLarge!.color!.withValues(alpha: 0.8)),
                      ),
                        ...
                        child: Container(
                          ...
                          child: CustomInkWell(
                            ...
                            child: Row(mainAxisSize: MainAxisSize.min, children: [
                              ...
                              Flexible(child: Text(couponController.couponList![itemIndex].code ?? '', style: ralewayMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeSmall), maxLines: 1, overflow: TextOverflow.ellipsis)),
                            ]),
                          ),
                        ),
                      ),
