        ...
        child: Container(
          ...
          child: Column(children: [
            ...
            (isPharmacy || isFood) ? Padding(
              ...
              child: TitleWidget(
                title: isPharmacy ? 'Featured store'.tr : 'Best store nearby'.tr,
                            ...
                            Container(
                              ...
                              child: CustomInkWell(
                                ...
                                child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                        ...
                                        child: Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                          ...
                                          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                            ...
                                            storeList[index].ratingCount! > 0 ? Row(mainAxisAlignment: MainAxisAlignment.start, children: [
                                              ...
                                              Text(storeList[index].avgRating!.toStringAsFixed(1), style: ralewayRegular),
                                              const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                  ...
                                  Expanded(
                                    flex: 1,
                                    child: Text(storeList[index].name ?? '', style: ralewayMedium),
                                  ),
                                      ...
                                      Positioned(
                                        ...
                                        child: Container(
                                          ...
                                          child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                            ...
                                            Text('${distance > 10 ? '10+' : distance.toStringAsFixed(1)} ${'Km'.tr}', style: ralewayBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeOverSmall)),
                                            const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                                            Text('From you'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeOverSmall)),
                                          ]),
                                        ),
                                      ),
                                    ]),
