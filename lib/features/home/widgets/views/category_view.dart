...
import 'package:liwas_user/features/home/widgets/category_pop_up.dart';
                            ...
                            child: SizedBox(
                              ...
                              child: Column(children: [
                                      ...
                                      child: Container(
                                        ...
                                        child: Center(
                                          child: Text(
                                            ...
                                            style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeExtraLarge, color: Theme.of(context).cardColor),
                                ...
                                Padding(
                                  ...
                                  child: Text(
                                    (index == 9 && categoryController.categoryList!.length > 10) ? 'See all'.tr : categoryController.categoryList![index].name!,
                                    style: ralewayMedium.copyWith(fontSize: 11, color: (index == 9 && categoryController.categoryList!.length > 10) ? Theme.of(context).primaryColor : Theme.of(context).textTheme.bodyMedium!.color),
                    ...
                    InkWell(
                      ...
                      child: Padding(
                        ...
                        child: CircleAvatar(
                          ...
                          child: Text('View all'.tr, style: TextStyle(fontSize: Dimensions.paddingSizeDefault, color: Theme.of(context).cardColor)),
                        ),
                      ),
                    ),
                ...
                child: InkWell(
                  ...
                  child: SizedBox(
                    ...
                    child: Column(children: [
                      ...
                      Expanded(child: Text(
                        (index == 9 && categoryController.categoryList!.length > 10) ?  'See all'.tr : categoryController.categoryList![index].name ?? '',
                        style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: (index == 9 && categoryController.categoryList!.length > 10) ? Theme.of(context).primaryColor : Theme.of(context).textTheme.bodyMedium!.color),
                        maxLines: 2, overflow: TextOverflow.ellipsis, textAlign: TextAlign.center,
                      )),
                    ]),
                  ),
