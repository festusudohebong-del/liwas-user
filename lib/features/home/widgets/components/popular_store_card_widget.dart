                            ...
                            children: [
                              ...
                              Expanded(
                                child: Column(
                                  ...
                                  children: [
                                    Text(store.name ?? '', maxLines: 1, overflow: TextOverflow.ellipsis, style: ralewayMedium),
                                    Text(store.address ?? '', maxLines: 1, overflow: TextOverflow.ellipsis, style: ralewayRegular.copyWith(color: Theme.of(context).disabledColor)),
                                      ...
                                      children: [
                                        Row(
                                          children: [
                                            ...
                                            Text(store.avgRating!.toStringAsFixed(1), style: ralewayRegular),
                                            const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                            Text('(${store.ratingCount})', style: ralewayRegular.copyWith(color: Theme.of(context).disabledColor)),
                                          ],
                                        ),
                                        const SizedBox(width: Dimensions.paddingSizeDefault),
                                        Text('${store.itemCount}' ' ' 'items'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).primaryColor)),
                                      ],
                                    ),
                                  ],
                                ),
