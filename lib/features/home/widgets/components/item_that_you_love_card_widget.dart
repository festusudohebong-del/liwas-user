                      ...
                      child: CartCountView(
                        ...
                        child: Center(
                          child: Container(
                            ...
                            child: Text("add".tr, style: ralewayBold.copyWith(color: Theme.of(context).cardColor)),
                          ),
                        ),
                      ),
                    ),
                  ...
                  child: Padding(
                    ...
                    child: Column(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      ...
                      Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                        ...
                        Text("(${item.ratingCount})", style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor)),
                      ]),
