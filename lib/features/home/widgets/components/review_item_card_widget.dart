                ...
                Expanded(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      Text(item!.name!, maxLines: 1, overflow: TextOverflow.ellipsis, style: ralewayBold),
                      ...
                      Wrap(crossAxisAlignment: WrapCrossAlignment.center, alignment: WrapAlignment.start, children: [
                        ...
                        Text(
                          ...
                          style: ralewayMedium, textDirection: TextDirection.ltr,
                        ),
                      ]),
                          ...
                          Container(
                            ...
                            child: isFood ? Column(
                              ...
                              item!.ratingCount! > 0 ? Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                                ...
                                const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                Text(item!.avgRating!.toStringAsFixed(1), style: ralewayRegular),
                                const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                                Text("(${item!.ratingCount})", style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                              ]) : const SizedBox(),
                            ...
                            child: CartCountView(
                              ...
                              child: Center(
                                child: Container(
                                  ...
                                  child: Text("add".tr, style: ralewayBold.copyWith(color: Theme.of(context).primaryColor)),
                                ),
                              ),
                            ),
                          ),
