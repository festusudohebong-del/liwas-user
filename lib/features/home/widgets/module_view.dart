...
import 'package:liwas_user/features/home/widgets/popular_store_view.dart';
  ...
  Widget build(BuildContext context) {
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
      ...
      splashController.moduleList != null ? splashController.moduleList!.isNotEmpty ? GridView.builder(
        ...
        padding: const EdgeInsets.only(top: Dimensions.paddingSizeSmall), child: Text('No module found'.tr),
        ...
        return (!AuthHelper.isLoggedIn() || locationController.addressList != null) ? addressList.isNotEmpty ? Column(
          children: [
            ...
            Padding(
              ...
              child: TitleWidget(title: 'Deliver to'.tr),
            ),
