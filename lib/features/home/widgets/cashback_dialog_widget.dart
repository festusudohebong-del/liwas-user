            ...
            children: [
              ...
              homeController.cashBackOfferList!.isNotEmpty ? Container(
                ...
                child: Column(
                          ...
                          return Container(
                            ...
                            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                              Container(
                                ...
                                child: Text('${PriceConverter.convertPrice(homeController.cashBackOfferList![index].cashbackAmount!)} ${homeController.cashBackOfferList![index].title}', style: ralewayBold),
                              ),

                              Padding(
                                padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault, vertical: Dimensions.paddingSizeSmall),
                                child: Text(
                                  '${'Min spent'.tr} ${PriceConverter.convertPrice(homeController.cashBackOfferList![index].minPurchase!)} '
                                      '| ${'Valid till'.tr} ${DateConverter.stringToReadableString(homeController.cashBackOfferList![index].endDate!)}',
                  ...
                  padding: const EdgeInsets.all(Dimensions.paddingSizeExtraSmall),
                  child: Text('No offer available'.tr, style: ralewayRegular.copyWith(color: Theme.of(context).hintColor)),
                ),
