        ...
        child: Column(mainAxisSize: MainAxisSize.min, mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          Padding(
            ...
            child: Text(
              ...
              style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall,color: Colors.white70),
          ...
          Row(mainAxisAlignment: MainAxisAlignment.end, children: [
            ...
            TextButton(
              ...
              'No thanks'.tr,
              style: ralewayRegular.copyWith(color: Colors.white70,fontSize: Dimensions.fontSizeSmall),
            )),
            ...
            TextButton(
              ...
              child:  Padding(padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeDefault,vertical: 5),
                child: Center(
                  child: Text(
                  'Yes accept'.tr, style: ralewayRegular.copyWith(color: Colors.white70,fontSize: Dimensions.fontSizeSmall),
                  ),
                ),
              )),
