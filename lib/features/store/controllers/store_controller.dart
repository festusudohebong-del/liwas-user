...
import 'package:liwas_user/features/store/domain/models/cart_suggested_item_model.dart';
...
import 'package:liwas_user/features/store/domain/models/recommended_product_model.dart';
import 'package:liwas_user/features/store/domain/models/store_banner_model.dart';
...
class StoreController extends GetxController implements GetxService {
  ...
  Future<void> getStoreSearchItemList(String searchText, String? storeID, int offset, String type) async {
    if(searchText.isEmpty) {
      showCustomSnackBar('Write item name'.tr);
    }else {
      _isSearching = true;
  ...
  void shareStore() {
    if(ResponsiveHelper.isDesktop(Get.context)){
      ...
      showCustomSnackBar('Store url copied'.tr, isError: false);
    } else {
      String shareUrl = '${AppConstants.webHostedUrl}${filteringUrl(store!.slug ?? '')}';
