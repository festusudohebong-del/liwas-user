...
import 'package:liwas_user/common/widgets/web_item_view.dart';
import 'package:liwas_user/common/widgets/web_item_widget.dart';
...
import 'package:liwas_user/features/store/widgets/customizable_space_bar_widget.dart';
import 'package:liwas_user/features/store/widgets/store_banner_widget.dart';
import 'package:liwas_user/features/store/widgets/store_description_view_widget.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';
import 'package:liwas_user/features/store/widgets/store_details_screen_shimmer_widget.dart';
import 'package:liwas_user/features/store/widgets/bottom_cart_widget.dart';
import 'package:liwas_user/features/store/widgets/filter_widget.dart';
                              ...
                              store?.discount != null ? Positioned(
                                ...
                                child: Container(
                                  ...
                                  child: Text('${store?.discount!.discountType == 'percent' ? '${store?.discount!.discount}%'
                                      ...
                                      '${'Discount will be applicable when order amount exceeds is more than'.tr} ${PriceConverter.convertPrice(store?.discount!.minPurchase)},'
                                      ' ${'Max'.tr}: ${PriceConverter.convertPrice(store?.discount!.maxDiscount)} ${'Discount is applicable'.tr}',
                                ...
                                child: Container(
                                  ...
                                  child: Row(children: [
                                    ...
                                    Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start,mainAxisAlignment: MainAxisAlignment.center, children: [
                                      Row(children: [
                                        Expanded(child: Text(
                                          store.name!, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge - (scrollingRate * 3), color: Theme.of(context).textTheme.bodyMedium!.color),
                                      ...
                                      Text(
                                        ...
                                        style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall - (scrollingRate * 2), color: Theme.of(context).disabledColor),
                                      ),
                                      SizedBox(height: ResponsiveHelper.isDesktop(context) ? Dimensions.paddingSizeExtraSmall : 0),
                                      Row(children: [
                                        Flexible(
                                          child: Text('Minimum order'.tr, style: ralewayRegular.copyWith(
                                        ...
                                        Text(
                                          ...
                                          style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall - (scrollingRate * 2), color: Theme.of(context).primaryColor),
                                        ),
                                      ]),
                                    ])),
                    ...
                    child: SizedBox(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text('Recommended for you'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge, fontWeight: FontWeight.w700)),
                          const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                          Text('Here is what you might like'.tr, style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                          const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                                            ...
                                            child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                                              Text(
                                                ...
                                                style: index == storeController.categoryIndex
                                                    ? ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor)
                                                    : ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall),
                                              ),
                                            ]),
                                          ),
                                        ),
                                        ...
                                        Expanded(
                                          child: TextField(
                                            ...
                                            decoration: InputDecoration(
                                              ...
                                              hintText: 'Search for items'.tr,
                                              hintStyle: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor),
                ...
                child: Column(children: [
                  ...
                  store?.announcementActive??false ? Container(
                    ...
                    child: Row(children: [
                      ...
                      Flexible(child: Text(store?.announcementMessage??'', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall))),
                    ]),
                  ) : const SizedBox(),
                  ...
                  (!ResponsiveHelper.isDesktop(context) && storeController.recommendedItemModel != null && storeController.recommendedItemModel!.items!.isNotEmpty) ? Column(
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('Recommended for you'.tr, style: ralewayMedium),
                      const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                  ...
                  child: Column(
                    children: [
                      Padding(
                        padding: const EdgeInsets.symmetric(horizontal: Dimensions.paddingSizeSmall),
                        child: Row(children: [
                          Text('All products'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeDefault)),
            ...
            child: Container(
              ...
              child: Row(mainAxisSize: MainAxisSize.min, children: [
                ...
                AnimatedContainer(
                  ...
                  child:  Center(
                    child: Text(
                      'Prescription order'.tr, textAlign: TextAlign.center,
