          ...
          slivers: [
            ...
            ResponsiveHelper.isDesktop(context) ? SliverToBoxAdapter(
                        ...
                        child: campaignController.basicCampaign != null ? Column(
                          ...
                          children: [
                            Text(
                              ...
                              style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeOverLarge, color: Colors.white),
                            ...
                            campaignController.basicCampaign!.startTime != null ? Row(children: [
                              ...
                              Text('${'Campaign schedule'.tr}:', style: ralewayRegular.copyWith(
                            ...
                            campaignController.basicCampaign!.startTime != null ? Row(children: [
                              ...
                              Text('${'Daily time'.tr}:', style: ralewayRegular.copyWith(
                                fontSize: Dimensions.fontSizeExtraSmall, color: Colors.white,
                              )),
                              const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                              Text(
              ...
              flexibleSpace: FlexibleSpaceBar(
                ...
                //   style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge, color: Colors.black),
                // ),
              ...
              child: Column(children: [
                ...
                campaignController.basicCampaign != null && !ResponsiveHelper.isDesktop(context) ? Column(
                  children: [
                    ...
                    Row(children: [
                      ...
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        Text(
                          campaignController.basicCampaign!.title!, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                          maxLines: 1, overflow: TextOverflow.ellipsis,
                        ),
                        Text(
                          campaignController.basicCampaign!.description ?? '', maxLines: 2, overflow: TextOverflow.ellipsis,
                  ...
                  child: Padding(
                    ...
                    child: Text('Store list'.tr, style: ralewayBold.copyWith(
