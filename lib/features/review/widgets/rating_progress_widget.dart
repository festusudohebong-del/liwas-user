...
class RatingProgressWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Row(children: [
      ...
      Text(ratingNumber, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall)),
      ...
      Container(
        ...
        width: 30,
        child: Text('${ratingPercent.toStringAsFixed(0)}%', style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).textTheme.bodyMedium!.color?.withValues(alpha: 0.5))),
      ),
