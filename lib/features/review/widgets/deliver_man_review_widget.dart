...
import 'package:liwas_user/features/review/widgets/delivery_man_widget.dart';
                    ...
                    !reviewController.isLoading ? CustomButton(
                      ...
                      onPressed: () async {
                        if (reviewController.deliveryManRating == 0) {
                          showCustomSnackBar('Give a rating'.tr, getXSnackBar: true);
                        } else if (_controller.text.isEmpty) {
                          showCustomSnackBar('Write a review'.tr, getXSnackBar: true);
                        } else {
