    ...
    return Expanded(
      child: Container(
        ...
        child: Text('$totalNumber ${isRating ? 'ratings'.tr : 'reviews'.tr}', textAlign: TextAlign.center,
          style: ralewayRegular.copyWith(fontSize:  ResponsiveHelper.isDesktop(context) ? Dimensions.fontSizeSmall : 8, color: Theme.of(context).textTheme.bodyLarge!.color?.withValues(alpha: 0.6)),
        ),
      ),
    );
  }
