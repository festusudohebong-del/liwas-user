...
import 'package:liwas_user/features/review/widgets/total_rating_review_view_widget.dart';
    ...
    return Container(
      ...
      child: ResponsiveHelper.isDesktop(context) ? Column(children: [
        ...
        Row(mainAxisAlignment:MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.end, children: [
          ...
          Text(averageRating!.toStringAsFixed(1), style: ralewayBold.copyWith(fontSize: 30)),

          Text('/5', style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeOverLarge)),
