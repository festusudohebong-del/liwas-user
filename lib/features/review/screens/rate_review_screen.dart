...
import 'package:liwas_user/features/review/widgets/deliver_man_review_widget.dart';
import 'package:liwas_user/features/review/widgets/item_review_widget.dart';
...
class RateReviewScreenState extends State<RateReviewScreen> with TickerProviderStateMixin {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: CustomAppBar(title: 'Rate review'.tr),
        ...
        Center(
          child: Container(
            ...
            child: TabBar(
              ...
              labelStyle: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall),
