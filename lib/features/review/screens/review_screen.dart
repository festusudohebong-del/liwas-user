...
import 'package:liwas_user/features/review/widgets/rating_widget.dart';
import 'package:liwas_user/features/review/widgets/review_list_widget.dart';
...
class _ReviewScreenState extends State<ReviewScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: CustomAppBar(title: widget.storeName ?? 'Store reviews'.tr),
      ...
      body: GetBuilder<ReviewController>(builder: (reviewController) {
          ...
          child: SingleChildScrollView(
            ...
            child: FooterView(
              child: Column(children: [
                ...
                WebScreenTitleWidget(title: widget.storeName ?? 'Store reviews'.tr),
        ...
        ) : Center(child: NoDataScreen(text: 'No review found'.tr, showFooter: true)) : const Center(child: CircularProgressIndicator());
      }),
    );
  }
}
