                      ...
                      child: Stack(clipBehavior: Clip.none, children: [
                        ...
                        Align(
                          ...
                          child: Column(
                            ...
                            (isFood || isShop) ? Text(item.storeName ?? '', style: ralewayRegular.copyWith(color: Theme.of(context).disabledColor), maxLines: 1, overflow: TextOverflow.ellipsis)
                                : Text(item.name ?? '', style: ralewayBold, maxLines: 1, overflow: TextOverflow.ellipsis),

                            (isFood || isShop) ? Flexible(
                              child: Text(
                                item.name ?? '',
                                style: ralewayBold, maxLines: 1, overflow: TextOverflow.ellipsis,
                              ),
