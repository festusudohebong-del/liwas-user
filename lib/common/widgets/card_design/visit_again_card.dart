          ...
          Container(
            ...
            child: CustomInkWell(
              ...
              child: Column(crossAxisAlignment: CrossAxisAlignment.center, mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                ...
                Flexible(child: Text(store.name ?? '', style: ralewayBold, maxLines: 1, overflow: TextOverflow.ellipsis)),
                ...
                Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                  ...
                  Text("(${store.ratingCount})", style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor)),
                ]),
                            ...
                            index == store.items!.length -1 ? Positioned(
                              ...
                              child: Container(
                                ...
                                child: Center(child: Text(
                                  (store.itemCount! > 20) ? '20+' : '${store.itemCount}', style: ralewayMedium.copyWith(color: Colors.white, fontSize: Dimensions.fontSizeExtraSmall),
                                )),
                              ),
                            ) : const SizedBox(),
                          ],
