                      ...
                      Expanded(
                        ...
                        child: Padding(
                          ...
                          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                            ...
                            Flexible(child: Text(store.name ?? '', maxLines: 1, overflow: TextOverflow.ellipsis, style: ralewayMedium)),
                            const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                       ...
                       child: Padding(
                         ...
                         child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                           ...
                           Row(children: [
                             ...
                             Text('${store.itemCount} ${'Items'.tr}', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).primaryColor)),
                            ...
                            Container(
                              ...
                              child: Row(children: [
                                ...
                                Text(
                                  ...
                                  style: ralewayBold.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeExtraSmall),
                                ),
                                const SizedBox(width: Dimensions.paddingSizeExtraSmall),
              ...
              store.avgRating! > 0 ? Positioned(
                ...
                child: Container(
                  ...
                  child: Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                    Text(store.avgRating!.toStringAsFixed(1), style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
