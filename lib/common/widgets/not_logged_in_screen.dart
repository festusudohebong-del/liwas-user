        ...
        child: Center(
          child: Column(mainAxisAlignment: MainAxisAlignment.center, mainAxisSize: MainAxisSize.min, children: [
            ...
            Text(
              ...
              style: ralewayBold.copyWith(fontSize: MediaQuery.of(context).size.height*0.023),
            ...
            Text(
              ...
              style: ralewayRegular.copyWith(fontSize: MediaQuery.of(context).size.height*0.0175, color: Theme.of(context).disabledColor),
              textAlign: TextAlign.center,
            ),
