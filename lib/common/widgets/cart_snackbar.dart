...
void showCartSnackBar() {
  ScaffoldMessenger.of(Get.context!).showSnackBar(SnackBar(
    ...
    content: Text('Item added to cart'.tr, style: ralewayMedium.copyWith(color: Colors.white)),
    action: SnackBarAction(label: 'View cart'.tr, onPressed: () => Get.toNamed(RouteHelper.getCartRoute()), textColor: Colors.white),
  ));
}
