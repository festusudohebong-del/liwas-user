      ...
      child: PointerInterceptor(
        child: SizedBox(width: 500, child: Padding(
          ...
          child: Column(mainAxisSize: MainAxisSize.min, children: [
            ...
            Padding(
              padding: const EdgeInsets.all(Dimensions.paddingSizeLarge),
              child: Text(description, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge), textAlign: TextAlign.center),
            ),
              ...
              return !orderController.isLoading ? Row(children: [
                Expanded(child: TextButton(
                  ...
                  child: Text(
                    ...
                    style: ralewayBold.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color),
                  ),
                )),
