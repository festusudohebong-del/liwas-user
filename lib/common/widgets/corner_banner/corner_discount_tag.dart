...
import 'package:liwas_user/common/widgets/corner_banner/positioned_banner.dart';
              ...
              children:  [
                Text(
                  discount! > 0 ? '$discount${discountType == 'percent' ? '%'
                      : Get.find<SplashController>().configModel!.currencySymbol} ${'Off'.tr}' : 'Free delivery'.tr,
