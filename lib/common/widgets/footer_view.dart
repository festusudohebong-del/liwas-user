          ...
          Container(
            ...
            child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween,crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              Expanded(flex: 4, child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                ...
                Text('Subscribe to out new channel to get latest updates'.tr, style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall)),
                const SizedBox(height: Dimensions.paddingSizeSmall),
                ...
                Container(
                  ...
                  child: Row(children: [
                    ...
                    Expanded(child: TextField(
                      ...
                      expands: false,
                      style: ralewayMedium.copyWith(color: Colors.black, fontSize: Dimensions.fontSizeExtraSmall),
                      decoration: InputDecoration(
                        hintText: 'Your email address'.tr,
                        hintStyle: ralewayRegular.copyWith(color: Colors.grey, fontSize: Dimensions.fontSizeExtraSmall),
                    ...
                    GetBuilder<SplashController>(builder: (splashController) {
                      return InkWell(
                        ...
                        child: Container(
                          ...
                          child: !splashController.isLoading ? Text('Subscribe'.tr, style: ralewayRegular.copyWith(color: Colors.white, fontSize: Dimensions.fontSizeExtraSmall))
                    ...
                    child: Row(
                      ...
                      children: [
                        ...
                        Column(crossAxisAlignment: CrossAxisAlignment.start, mainAxisAlignment : MainAxisAlignment.spaceBetween, children: [
                          ...
                          FooterButton(title: 'Become a store owner'.tr, route: RouteHelper.getRestaurantRegistrationRoute()),
                          const SizedBox(height: Dimensions.paddingSizeDefault),

                          FooterButton(title: 'Become a delivery man'.tr, route: RouteHelper.getDeliverymanRegistrationRoute()),
                          const SizedBox(height: Dimensions.paddingSizeDefault),

                          FooterButton(title: 'Help support'.tr, route: RouteHelper.getSupportRoute()),
                          const SizedBox(height: Dimensions.paddingSizeDefault),

                          FooterButton(title: 'Privacy policy'.tr, route: RouteHelper.getHtmlRoute('privacy-policy')),
                          const SizedBox(height: Dimensions.paddingSizeDefault),

                          FooterButton(title: 'Terms and condition'.tr, route: RouteHelper.getHtmlRoute('terms-and-condition')),
                        ...
                        Column(children: [
                          ...
                          Text('Send us mail'.tr, style: ralewayBold),
                          const SizedBox(height: Dimensions.paddingSizeSmall),
                          ...
                          InkWell(
                            ...
                            child: Text(_config.email ?? '', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall)),
                          ),
                        ...
                        Column(children: [
                          ...
                          Text('Contact us'.tr, style: ralewayBold),
                          const SizedBox(height: Dimensions.paddingSizeSmall),

                          Text(_config.phone ?? '', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall)),
                        ...
                        Column(children: [
                          ...
                          Text('Find us here'.tr, style: ralewayBold),
                          const SizedBox(height: Dimensions.paddingSizeSmall),
              ...
              child: SizedBox(
                ...
                child: Center(
                  child: Text(
                    ...
                    style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, fontWeight: FontWeight.w400),
                  ),
                ),
              ),
            ),
  ...
  Widget build(BuildContext context) {
    return TextHover(builder: (hovered) {
      return InkWell(
        ...
        child: Text(title, style: hovered ? ralewayMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeExtraSmall)
            : ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall)),
      );
    });
  }
}
