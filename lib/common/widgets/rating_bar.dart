...
class RatingBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    ratingCount != null ? starList.add(Padding(
      ...
      child: Text('($ratingCount)', style: ralewayRegular.copyWith(fontSize: size*0.8, color: Theme.of(context).textTheme.bodyLarge!.color!.withValues(alpha: 0.7)), textDirection: TextDirection.ltr),
    )) : const SizedBox();
