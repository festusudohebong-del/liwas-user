                    ...
                    languageList.add(DropdownItem<int>(value: index, child: Row(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Text(AppConstants.languages[index].languageName!, style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall),),
                        ),
                      ],
                    )));
                  }
                  ...
                  for(int index=0; index<AppConstants.joinDropdown.length; index++) {
                    if(index != 0) {
                      joinUsList.add(DropdownItem<int>(value: index, child: Padding(
                        ...
                        child: Text(AppConstants.joinDropdown[index].tr, style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, fontWeight: FontWeight.w100, color: Get.find<ThemeController>().darkTheme ? Colors.white : Colors.black)),
                      )));
                    }
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: Text(
                                ...
                                style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall),
                              ),
                            ),
                          ],
                        ),
                      ...
                      child: CustomDropdown<int>(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Text(AppConstants.joinDropdown[0].tr, style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, fontWeight: FontWeight.w100, color: Get.find<ThemeController>().darkTheme ? Colors.white : Colors.black)),
                          ],
                        ),
                      ),
              ...
              children: [
                MenuButton(title: 'Home'.tr, onTap: () {
                  if(AddressHelper.getUserAddressFromSharedPref() != null) {
                    ...
                    showCustomSnackBar('Please select address first'.tr,);
                  }
                }),
                const SizedBox(width: 20),
              ...
              return InkWell(
                ...
                child: Container(
                  ...
                  child: Row(children: [
                    ...
                    const SizedBox(width: Dimensions.paddingSizeSmall),
                    Text(authController.isLoggedIn() ? 'Profile'.tr : 'Sign in'.tr, style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, fontWeight: FontWeight.w100)),
                  ]),
                ),
              );
            }),
  ...
  Widget build(BuildContext context) {
    return TextHover(builder: (hovered) {
      return InkWell(
        ...
        child: Text(title, style: ralewayRegular.copyWith(color: hovered ? Theme.of(context).primaryColor : null)),
      );
    });
  }
}
            ...
            (isCart && cartController.cartList.isNotEmpty) ? Positioned(
              ...
              child: Container(
                ...
                child: Text(
                  ...
                  style: ralewayRegular.copyWith(fontSize: 12, color: Theme.of(context).cardColor),
                ),
              ),
            ) : const SizedBox()
          ]);
