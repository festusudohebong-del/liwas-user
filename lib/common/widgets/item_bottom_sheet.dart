...
import 'package:liwas_user/common/widgets/item_bottom_sheet_shimmer.dart';
                      ...
                      Padding(
                        ...
                        child: Column(mainAxisAlignment: MainAxisAlignment.center, crossAxisAlignment: CrossAxisAlignment.start, children: [
                          ...
                          Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            Expanded(
                              child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                                Text(
                                  item.name!, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge),
                                ...
                                InkWell(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Text(
                                      item.storeName ?? '',
                                      style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).primaryColor),
                                    ),
                                  ),
                                ),
                                ...
                                Text(
                                  ...
                                  style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge), textDirection: TextDirection.ltr,
                                ),
                                price > priceWithDiscount ? Text(
                                  ...
                                  style: ralewayMedium.copyWith(color: Theme.of(context).disabledColor, decoration: TextDecoration.lineThrough),
                                ) : const SizedBox(),
                              ]),
                            ),
                            ...
                            Column(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.end, children: [
                                ...
                                return InkWell(
                                  onTap: () {
                                    if(AuthHelper.isLoggedIn()) {
                                      ...
                                      showCustomSnackBar('You are not logged in'.tr, getXSnackBar: true);
                                    }
                                  },
                                  child: Container(
                                    decoration: BoxDecoration(
                              ...
                              item.isStoreHalalActive! && item.isHalalItem! ? Padding(
                                ...
                                child: CustomToolTip(
                                  message: 'This is a halal food'.tr,
                          ...
                          (item.description != null && item.description!.isNotEmpty) ? Column(
                            ...
                            children: [
                              Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                                ...
                                Text('Description'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                                ...
                                ((Get.find<SplashController>().configModel!.moduleConfig!.module!.unit! && item.unitType != null)
                                  ...
                                  child: Get.find<SplashController>().configModel!.moduleConfig!.module!.unit! ? Text(
                                    ...
                                    Text(item.veg == 1 ? 'Veg'.tr : 'Non veg'.tr, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeDefault)),
                                  ]),
                                ) : const SizedBox(),
                              ...
                              Text(item.description!, style: ralewayRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color?.withValues(alpha: 0.5))),
                              const SizedBox(height: Dimensions.paddingSizeLarge),
                            ],
                          ) : const SizedBox(),
                          ...
                          (item.nutritionsName != null && item.nutritionsName!.isNotEmpty) ? Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Nutrition details'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                              const SizedBox(height: Dimensions.paddingSizeExtraSmall),

                              Wrap(children: List.generate(item.nutritionsName!.length, (index) {
                                return Text(
                                  '${item.nutritionsName![index]}${item.nutritionsName!.length - 1 == index ? '.' : ', '}',
                                  style: ralewayRegular.copyWith(color: Theme.of(context).textTheme.bodyLarge!.color?.withValues(alpha: 0.5)),
                                );
                              })),
                              const SizedBox(height: Dimensions.paddingSizeLarge),
                            ],
                          ...
                          (item.allergiesName != null && item.allergiesName!.isNotEmpty) ? Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Allergic ingredients'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                              const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                          ...
                          (item.genericName != null && item.genericName!.isNotEmpty) ? Column(
                            crossAxisAlignment: CrossAxisAlignment.start,
                            children: [
                              Text('Generic name'.tr, style: ralewayBold.copyWith(fontSize: Dimensions.fontSizeLarge)),
                              const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                          ...
                          isAvailable ? const SizedBox() : Container(
                            ...
                            child: Column(children: [
                              Text('Not available now'.tr, style: ralewayMedium.copyWith(
                                color: Theme.of(context).primaryColor, fontSize: Dimensions.fontSizeLarge,
                              )),
                              Text(
                                '${'Available will be'.tr} ${DateConverter.convertTimeToTime(item.availableTimeStarts!)} '
                    ...
                    Builder(
                        builder: (context) {
                          ...
                          return Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                            Text('${'Total amount'.tr}:', style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).primaryColor)),
                            const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                            Row(children: [
                              discount! > 0 ? PriceConverter.convertAnimationPrice(
                                (price * itemController.quantity!) + addonsCost,
                                textStyle: ralewayMedium.copyWith(color: Theme.of(context).disabledColor, fontSize: Dimensions.fontSizeSmall, decoration: TextDecoration.lineThrough),
                              ) : const SizedBox(),
                              const SizedBox(width: Dimensions.paddingSizeExtraSmall),

                              PriceConverter.convertAnimationPrice(
                                withAddonCost,
                                textStyle: ralewayBold.copyWith(color: Theme.of(context).primaryColor),
                              ),
                            ]),
                          ]);
                        }
                    ...
                    SafeArea(
                      child: Row(children: [
                        ...
                        Row(children: [
                          ...
                          Text(itemController.quantity.toString(), style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
                          QuantityButton(
                        ...
                        Expanded(child: GetBuilder<CartController>(builder: (cartController) {
                          return CustomButton(
                            ...
                            buttonText: (Get.find<SplashController>().configModel!.moduleConfig!.module!.stock! && stock! <= 0)
                                ? 'Out of stock'.tr : widget.isCampaign ? 'Order now'.tr
                                : (widget.cart != null || itemController.cartIndex != -1) ? 'Update in cart'.tr : 'Add to cart'.tr,
                              ...
                              if(_newVariation) {
                                for(int index=0; index<item.foodVariations!.length; index++) {
                                  if(!item.foodVariations![index].multiSelect! && item.foodVariations![index].required!
                                    ...
                                    invalid = '${'Choose a variation from'.tr} ${item.foodVariations![index].name}';
                                    break;
                                    ...
                                    invalid = '${'Select minimum'.tr} ${item.foodVariations![index].min} '
                                        '${'And up to'.tr} ${item.foodVariations![index].max} ${'Options from'.tr}'
                                  ...
                                  if (Get.find<CartController>().existAnotherStoreItem(
                                    ...
                                    Get.dialog(ConfirmationDialog(
                                      ...
                                      description: Get.find<SplashController>().configModel!.moduleConfig!.module!.showRestaurantText!
                                          ? 'If you continue'.tr : 'If you continue without another store'.tr,
                                      onYesPressed: () {
                                        Get.back();
...
class AddonView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Text('Addons'.tr, style: ralewayMedium),
          ...
          Container(
            ...
            child: Text(
              'Optional'.tr,
              style: ralewayRegular.copyWith(color: Theme.of(context).hintColor, fontSize: Dimensions.fontSizeSmall),
            ),
          ),
        ]),
        const SizedBox(height: Dimensions.paddingSizeExtraSmall),
                  ...
                  child: Row(children: [
                    ...
                    Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                      ...
                      Text(
                        ...
                        style: itemController.addOnActiveList[index] ? ralewayMedium : ralewayRegular.copyWith(color: Theme.of(context).hintColor),
                      ),
                    ...
                    Text(
                      ...
                      style: itemController.addOnActiveList[index] ? ralewayMedium.copyWith(fontSize: Dimensions.fontSizeSmall)
                          : ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall, color: Theme.of(context).disabledColor),
                    ),
    ...
    return ListView.builder(
      ...
      itemBuilder: (context, index) {
        return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          Text(item!.choiceOptions![index].title!, style: ralewayMedium),
          const SizedBox(height: Dimensions.paddingSizeSmall),
          Container(
            decoration: BoxDecoration(
              borderRadius: BorderRadius.circular(Dimensions.radiusSmall),
        ...
        return Container(
          ...
          child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, crossAxisAlignment: CrossAxisAlignment.center, children: [
              Text(item!.foodVariations![index].name!, style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeLarge)),
            ...
            item!.foodVariations![index].multiSelect! ? Text(
              '${'Select minimum'.tr} ${'${item!.foodVariations![index].min}'
                  ' ${'And up to'.tr} ${item!.foodVariations![index].max} ${'Options'.tr}'}',
              style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor),
            ) : Text(
              'Select one'.tr,
              style: ralewayMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).primaryColor),
            ),
                ...
                return Padding(
                  ...
                  child: InkWell(
                    ...
                    child: Row(children: [
                      ...
                      Text(
                        '${'View'.tr} ${item!.foodVariations![index].variationValues!.length - 4} ${'More option'.tr}',
                      ...
                      child: Row(children: [
                        ...
                        Row(crossAxisAlignment: CrossAxisAlignment.center, children: [
                          ...
                          Text(
                            ...
                            maxLines: 1, overflow: TextOverflow.ellipsis,
                            style: itemController.selectedVariations[index][i]! ? ralewayMedium : ralewayRegular.copyWith(color: Theme.of(context).hintColor),
                          ),
                        ...
                        showOriginalPrice ? Text(
                          ...
                          maxLines: 1, overflow: TextOverflow.ellipsis, textDirection: TextDirection.ltr,
                          style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor, decoration: TextDecoration.lineThrough),
                        ) : const SizedBox(),
                        ...
                        Text(
                          ...
                          maxLines: 1, overflow: TextOverflow.ellipsis, textDirection: TextDirection.ltr,
                          style: itemController.selectedVariations[index][i]! ? ralewayMedium.copyWith(fontSize: Dimensions.fontSizeExtraSmall)
                              : ralewayRegular.copyWith(fontSize: Dimensions.fontSizeExtraSmall, color: Theme.of(context).disabledColor),
                        ),
