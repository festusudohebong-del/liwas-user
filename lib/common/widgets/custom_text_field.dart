...
import 'package:liwas_user/common/widgets/code_picker_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: [
        ...
        widget.showTitle ? Text(widget.titleText, style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall)) : const SizedBox(),
        ...
        InkWell(
          ...
          child: TextFormField(
            ...
            style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeLarge),
            ...
            decoration: InputDecoration(
              ...
              hintStyle: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).hintColor),
              filled: true,

              labelStyle : widget.showLabelText ? ralewayRegular.copyWith(fontSize: Dimensions.fontSizeDefault, color: Theme.of(context).hintColor) : null,
              errorStyle: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeSmall),
              ...
              label: widget.showLabelText ? Text.rich(TextSpan(children: [
                ...
                if(widget.required && widget.labelText != null)
                  TextSpan(text : ' *', style: ralewayRegular.copyWith(color: Theme.of(context).colorScheme.error, fontSize: Dimensions.fontSizeLarge)),

                if(widget.isEnabled == false)
                  TextSpan(text: widget.fromUpdateProfile ? ' (${'Non changeable'.tr})' : ' (${'Non changeable'.tr})', style: ralewayRegular.copyWith(fontSize: Dimensions.fontSizeLarge, color: Theme.of(context).colorScheme.error)),
                ...
                Container(
                  ...
                  child: Center(
                    child: CodePickerWidget(
                      ...
                      textStyle: ralewayRegular.copyWith(
