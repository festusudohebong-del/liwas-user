...
import 'package:liwas_user/features/search/widgets/voice_search_bottom_sheet.dart';
...
class VoicePermissionHandler {
  ...
  static Future<bool> requestMicrophonePermission() async {
    ...
    if (status.isRestricted) {
      showCustomSnackBar('Microphone restricted'.tr);
      return false;
    }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Microphone permission required'.tr,
                ...
                Text(
                  GetPlatform.isWeb ? 'Microphone permission message web'.tr : 'Microphone permission message'.tr,
                  style: TextStyle(
                    fontSize: 14,
